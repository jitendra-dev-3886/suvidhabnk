...
if($user_bal >= 0){
    ...
    $insert_report = "INSERT INTO `pay_bill_api`(`MESSAGE`, `STATUS`, `SEND_DATA` ,`CATEGORY`, `OP_NAME`, `TIMESTAMP` , `RESPONSE_CODE`, `RESPONSE`,`OPERATORID`, `ACKNO` , `USER_ID` , `REFFRENCE_ID` , `CA_NUM` , `OPERATOR` ,`AMOUNT`, `MODE` , `FILTER_DATE`) VALUES 
('' ,'Pending','$fetchreq' ,'$category' ,'$opname' ,'".date("g:i:s A")."' ,'','','', '',  '$usid' , '$billfetchrefid'  ,'$canumber'  , '$billid' , '$amount' , 'ONLINE' , '".date("Y-m-d")."')";
