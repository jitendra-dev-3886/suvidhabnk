              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td> <a href="SetBBPSOfflineBBPSCommission1.php?rid=<?php echo $setBBPS['ID']; ?>" class='fas fa-edit'></a><a href="#" name="button" onclick = "deletedata(<?php echo $setBBPS['ID']; ?>);"><i class="fas fa-trash"></i></i></a></i></td>
