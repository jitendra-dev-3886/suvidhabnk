...
$memeberid = $con->query("SELECT * FROM user WHERE date(DATE) between '$fromdate' AND '$todate'");
$userdata = "";
...
if (isset($_POST['pageid']) && $_POST['pageid'] == 7)
{
    ...
    $sql = "SELECT * FROM fund $filterquery and USER_ID<>'' and TRANS_DATE between '$fromdate' and '$todate' order by ID desc";
// echo $sql;

    $result = mysqli_query($con, $sql);
    $userdata = "";

    $userdata .= '<table id="tbcard" class="table table-bordered table-striped">
