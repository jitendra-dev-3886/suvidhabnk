                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      <?php
                         ...
                         if($res->num_rows >0){
                             while($setBBPS = $res->fetch_assoc()){
                      
                      ?>
                  <tr>
                    <td><?php echo $i++; ?></td>
                    <td><?php echo $setBBPS['MIN_AMOUNT']; ?></td>
                    <td><?php echo $setBBPS['MAX_AMOUNT']; ?></td>
                    <td><?php echo $setBBPS['AMOUNT']; ?></td>
                    <td><?php echo $setBBPS['DS_COM']; ?></td>
                    <td><?php echo $setBBPS['GST']; ?></td>
                    <td><?php echo $setBBPS['TDS']; ?></td>
                    <td><?php echo $setBBPS['TYPE']; ?></td>
                    <td><?php echo $setBBPS['DATE']; ?></td>
                    <td><?php echo $setBBPS['MAIN_OWNER']; ?></td>
                    
                    <td><a href="SetBBPSOnlineBBPSCommission1.php?rid=<?php echo $setBBPS['ID']; ?>" class='fas fa-edit'></a>

                        <a href="#" name="button" onclick = "deletedata(<?php echo $setBBPS['ID']; ?>);"><i class="fas fa-trash"></i></i></a></i></td>
 ...
 $(document).ready(function(){  
      $('#setCom').click(function(e){ 
          e.preventDefault()
           ...
           {  
                $.ajax({  
                     url:"handler/SetBBPSCommission.php",  
                     method:"POST",  
