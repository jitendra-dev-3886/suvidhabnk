            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                   ...
                   <div class="form-row d-flex justify-content-around">
                       ...
                       <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">Categories</label>
                          <?php $category = $con->query("select * from add_category WHERE STATUS = 'ACTIVE'"); ?>
                        <select class="form-control select2" id="categories" name="categories" style="width: 100%;">
                            <option>Select categories</option>a
                            <?php while($category_row = $category->fetch_assoc()){ ?>
                                                 <option value = "<?php echo $category_row['CATEGORY'] ?>"><?php echo $category_row['CATEGORY'] ?></option>
                                                <?php } ?>
                     ...
                     <div class="form-row d-flex justify-content-around">
                       ...
                       <div class="form-group col-md-6">
                            ...
                            <input type="text" id="writtenby" name="writtenby" class="form-control" placeholder="Written by">
                       </div>
                     </div>
                  <div class="form-row d-flex justify-content-around">   
                     <div class="form-group col-md-6">
                     ...
                     <div class="form-group col-md-6">
                            ...
                            <input type="text" id="website_name" name="website_name" class="form-control" placeholder="Enter Link Name">
                       </div>
                  </div>  
                ...
                <div class="card-footer d-flex justify-content-center">
                  <button type="submit" id="add_blog" name="add_blog" class="btn btn-primary">Add Blog</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
