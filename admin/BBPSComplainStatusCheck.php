  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Check Complaint</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Check Complaint</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
               <div class="card-header">
                <h3 class="card-title"><?php echo $type.$mode ?> Bharat BillPay Report Data Table</h3>
                
                  <img src="../Agent/img/BBPS_Logo.png" width="120" style="float:right">
              </div>
              <!-- /.card-header -->
              ...
              <div class="row">
                  ...
                  <div class="search px-4 col-md-4">
                    ...
                    <input type="text" id="tid" value="" class="form-control">
                 </div>
                <div class="search px-4 col-md-2">
                <span id="datesbtn" class="searchicon" onclick="checkComplain($('#tid').val())"><i class="fas fa-search"></i></span>
                 </div>
                </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Complain Managment</h5>
          ...
          <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-row d-flex justify-content-around ">
                          <div class="form-group col-md-10">
                            <label for="exampleInputEmail1">Txn. Ref ID </label>
                            <input type="text" class="form-control" id='refid' name='refid'  placeholder="refid">
                          </div>
                          <div class="form-group col-md-10">
                            <label for="exampleInputEmail1">OP ID </label>
                            <input type="text" class="form-control" id="opid" name="opid" placeholder="opid">
                          </div>
                          <div class="form-group col-md-10">
                ...
                <div class="card-footer d-flex justify-content-center">
                  <button class="btn btn-primary" type="submit">Complain</button>
                </div>
                </div>
...
function showmodalcomplain(refid , opid ){
    $("#refid").val(refid);
    $("#opid").val(opid);
...
$("#complainForm").submit(function(e){
          e.preventDefault();
             $("#loading_ajax").show();
             $.ajax({
                 url:'Backend/BBPS/billAvenue/main.php',
                 type:'post',
                 ...
                 success:function(data, status){
                    ...
                    console.log(data);
                     let rslt = JSON.parse(data);
                      ...
                      let msg = rslt.responseReason; 
                    if(rs_code == "000"){
                       Swal.fire({
                              title: 'Congratulations',
                              html: "<pre>Complain Assingned To: "+rslt.complaintAssigned+"  \n" + msg + "</pre>",
                              icon: 'success',
                              button: "Okay",
     ...
     function checkComplain(refid){
           $("#loading_ajax").show();
             $.ajax({
                 url:'Backend/BBPS/billAvenue/main.php',
                 type:'post',
                 data: {checkrefid :refid},
                  beforeSend:function(xhr){xhr.setRequestHeader('Token', localStorage.getItem('Token'));},
                 success:function(data, status){
                     $("#loading_ajax").hide();
                    console.log(data);
    ...
    var tod = $("#todate").val();
      $.ajax({
        ...
        method:"POST",
        data:{mode:"ONLINE",pageid:1,formdate:fromd,todate:tod},
...
//             url : "handler/BBPS_Report.php",
//             type : "POST",
//             data : {formdate:fromd,todate:tod,mode:"ONLINE",pageid:2},
