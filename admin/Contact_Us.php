            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                     <div class="form-row d-flex justify-content-around">
                       <div class="form-group col-md-6">
                            ...
                            <input type="text" id="mobile1" name="mobile1" class="form-control" value="<?php echo $mobile?>">
                       </div>
                       <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">EMAIL</label>
                            <input type="text" id="email1" name="email1" class="form-control" value="<?php echo $email?>">
                            <input type="hidden" id="idd" name="idd" class="form-control" value="1">
                       </div>
                       <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">ADDRESS</label>
                            <input type="text" id="address1" name="address1" class="form-control" value="<?php echo $address?>">
                       </div>
                     </div>
                ...
                <div class="card-footer d-flex justify-content-center">
                  <button type="submit" id="add_blog" name="add_blog" class="btn btn-primary">Add Contact</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
