  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Bharat BillPay</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Bharat BillPay</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
               <div class="card-header">
                <h3 class="card-title"><?php echo $type.$mode ?> Bharat BillPay</h3>
              ...
              <div class="search px-4 col-md-4">
                ...
                <input type="date" id="todate" value="<?php echo date("Y-m-d") ?>" class="form-control">
                  ...
                  <div class="search px-4 col-md-4">
                    <label>Mobile : </label>
                    <input type="number" id="Mobile" value="" class="form-control">
                 </div>
                  <div class="search px-4 col-md-4">
                    <label>Txn Id : </label>
                ...
                <div class="card-body">
                    ...
                    <div class="form-row d-flex justify-content-around ">
                          ...
                          <!--  <label for="exampleInputEmail1">Txn. Ref ID </label>-->
                            <input type="hidden" class="form-control" id='refid' name='refid'  placeholder="refid">
                          <!--</div>-->
                          <div class="form-group col-md-10">
                            <label for="exampleInputEmail1">Txn. Ref ID</label>
