          ...
          <div class="col-12">
            ...
            <div class="card scrollmenu">
              <div class="card-header">
                <h3 class="card-title">Live Transaction Show</h3>
              </div>
           
                <h2 id="loadingtext" class="px-4"></h2>
              <!-- /.card-header -->
              
              <div class="card-body" id="LiveReport">
...
<script>
    function load_data()
    {
      ...
      $.ajax({
        url:"handler/LiveReport.php",
        method:"POST",
        data:{pageid:1},
        success:function(data)
        {
          $("#loadingtext").text("");
          $('#LiveReport').html(data);
