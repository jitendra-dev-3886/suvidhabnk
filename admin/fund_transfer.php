                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                                ...
                                                                <div class="tab-content card-block">
                                                                    <div class="tab-pane active" id="i" role="tabpanel">
                                                                       <div class="card-block my-3">
                                                                            ...
                                                                            <form class="form-material" id="fund_transfer_form">
                                                                                ...
                                                                                <div class="form-row mt-3 d-flex justify-content-around">
                                                                                    <div class="form-group form-primary col-md-5">
                                                                                        ...
                                                                                        <input type="hidden" name="fund_transfer" value="1">
                                                                                        <span class="form-bar"></span>
                                                ...
                                                <!--// <!--                        <td>-->
                                                <!--                            <?php 
                                                // if( $fund_transfer['OWNER_PREVIOUS_AMOUNT'] > $fund_transfer['OWNER_AFTER_AMOUNT']){-->
                                                // <!--                                echo "Debit";-->
                                                // <!--                            }-->
...
<script>
    $('#fund_transfer_form').submit(function(e){
        e.preventDefault();
    $.ajax({
        url:"handler/fund_transfer.php",
        type:'POST',
        ...
        success: function(data){
            if(data==1){
                swal.fire({
                    icon:'error',
                    title: 'Error...',
                    text: 'Sorry This is illegal Transaction!',
                    button: 'okay'
                }).then(function(){
                ...
                swal.fire({
                    icon:'success',
                    title: 'Success...',
                    text: 'Successfully MAIN Amount is Debited!',
                    button: 'okay'
                }).then(function(){
                    location.replace('fund_transfer.php');
                });
                ...
                swal.fire({
                    icon:'success',
                    title: 'Success...',
                    text: 'Successfully MAIN Amount is Credited!',
                    button: 'okay'
                }).then(function(){
                    location.replace('fund_transfer.php');
                });
                ...
                swal.fire({
                    icon:'success',
                    title: 'Success...',
                    text: 'Successfully Aeps Amount is Debited!',
                    button: 'okay'
                }).then(function(){
                    location.replace('fund_transfer.php');
                });
                ...
                swal.fire({
                    icon:'success',
                    title: 'Success...',
                    text: 'Seccessfully Aeps Amount is Credited!',
                    button: 'okay'
                }).then(function(){
                    location.replace('fund_transfer.php');
                });
