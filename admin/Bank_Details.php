            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                   ...
                   <div class="form-row d-flex justify-content-around">
                       ...
                       <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">Account Holder Name</label>
                          <input type="text" class="form-control" id="h_name" name="h_name" style="width: 100%;" value="<?php echo $acc_hol_name?>">
                          <input type="hidden" id ="id" name="id" value="9">
                      </div>
                     
                     <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">QR Code</label>
                            <input type="file" class="form-control" name="qr_image" id="qr_image">
                        </div>
                     </div> 
                     <div class="form-row d-flex justify-content-around">
                       <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Bank Name</label>
                            <input type="text" id="bnk_name" name="bnk_name" class="form-control" value="<?php echo $bnk_name?>">
                       </div>
                       <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Account No.</label>
                            <input type="text" id="acc_no" name="acc_no" class="form-control" value="<?php echo $acc_number?>">
                       </div>
                     </div>
                  <div class="form-row d-flex justify-content-around">   
                     <div class="form-group col-md-6">
                ...
                <div class="card-footer d-flex justify-content-center">
                  <button type="submit" id="add_blog" name="add_blog" class="btn btn-primary">Update Bank Details</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
       ...
       if(data == 1){
             Swal.fire({
              ...
              button: 'Okay'
                      ...
                      location.replace('Bank_Details.php');
             });
