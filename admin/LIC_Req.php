  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Offline LIC Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Ofline LIC Report</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Offline LIC Report Data Table</h3>
              </div>
              <!-- /.card-header -->
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">LIC Offline Status Update</h5>
     ...
     $.ajax({
        ...
        success: function(data) {
         ...
         if(data == 1){
             swal.fire({
  title: "Success!",
  text: "LIC Offline Request Update Successfully",
  icon: "success",
  button: "Ok",
}).then(function(){
    load_data();
    $("#myModal").modal("hide");
             ...
             swal.fire({
  title: "OOPS!",
  text: "LIC Offline Request Update Unsuccessfull..!",
  icon: "error",
  button: "Close",
});
         }
