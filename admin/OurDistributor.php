            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="position" value="DISTRIBUTOR">
                   ...
                   <div class="form-row d-flex justify-content-around">
                       <div class="form-group col-md-5">
                          ...
                          <div class="form-group col-md-5">
                            ...
                            <input type="text" id="DistributorNAME" name="DistributorNAME" class="form-control" placeholder="Name">
                          </div>
                     </div>
                ...
                <div class="form-row d-flex justify-content-around">
                    ...
                    <div class="form-group col-md-5">
                     ...
                     <!--   <input type="number" id="mobile_num" name="mobile_num" class="form-control" placeholder="">-->
                     <!-- </div>-->
                     </div>
                ...
                <div class="card-footer d-flex justify-content-center">
                  <button type="submit" id="add_team" name="add_team" class="btn btn-primary">Add Distributor</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
...
<script>
    ...
    var tod = $("#todate").val();
      $.ajax({
        url:"handler/OurDistributor.php",
        method:"POST",
...
// $(document).ready(function(){
  ...
  $.ajax({
     ...
     success: function(data){
       if(data == 1){
             Swal.fire({
              icon: 'success',
              title: 'Distributer added successfully..',
              button: 'Okay'
             }).then(function(){
                      location.replace('OurDistributor.php');
             });
  ...
  icon: 'error',
  title: 'OOPS..!',
  text: 'Distributer added Unsuccessfull..!',
  button: 'Close'
});
     }
     },
