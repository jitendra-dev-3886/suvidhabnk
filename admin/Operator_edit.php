...
$sql_quer=$con->query("select * from operatorManager WHERE ID='$edit_id'")->fetch_assoc();
$serviceid=$sql_quer['SERVICE'];
$serviceid_query=$con->query("SELECT * FROM `service_manager` WHERE `ID`='$serviceid'")->fetch_assoc();
$serviceapi=$sql_quer['SERVICEAPI'];
$serviceapi_query=$con->query("SELECT * FROM `rechargeApi` WHERE `ID`='$serviceapi'")->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Operator Manager Edit</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Operator Manager Edit</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                                                        ...
                                                        <form id="add_data">
                                                            <div class="form-row d-flex justify-content-around">
                                                                <div class="form-group form-primary col-md-3">
                                                                    ...
                                                                    <select name="selectservicee" required class="form-control">
                                                                        <option value="<?php echo $serviceid_query['ID']?>"><?php echo $serviceid_query['SERVICE']?> (Already Selected)</option>
                                                                         <?php
                                                                ...
                                                                <div class="form-group form-primary col-md-3">
                                                                    ...
                                                                    <select name="serviceapi" required class="form-control ">
                                                                        <option value="<?php echo $serviceapi_query['ID']?>"><?php echo $serviceapi_query['NAME']?> (Already Selected)</option>
                                                                         <?php
                                                                ...
                                                                <div class="form-group form-primary col-md-3">
                                                                    ...
                                                                    <input type="text" name="productname" required class="form-control" value="<?php echo $sql_quer['PRODUCTNAME']?>">
                                                                    <input type="hidden" name="uniqid" id="uniqid" value="7">
                                                                    <input type="hidden" name="op_manager" id="op_manager" value="<?php echo $edit_id?>">
                                                                </div>
                                                            </div>
                                                            <div class="form-row d-flex justify-content-around">
                                                                <div class="form-group form-primary col-md-3">
                                                                    <label>Input Product Code from api doc</label>
                                                                    <input type="text" name="productcode"required  class="form-control" value="<?php echo $sql_quer['PRODUCTCODE']?>">
                                                                    
                                                                </div>
                                                                <div class="form-group form-primary col-md-3">
                                                                    <label>Type</label>
                                                                    <select name="type" required class="form-control ">
                                                                        <option value="<?php echo $sql_quer['APISERVICENAME']?>"><?php echo $sql_quer['APISERVICENAME']?> (Already Selected)</option>
                                                                ...
                                                                <div class="form-group form-primary col-md-3">
                                                                    ...
                                                                    <select name="status" required class="form-control ">
                                                                        <option value="<?php echo $sql_quer['STATUS']?>"><?php echo $sql_quer['STATUS']?> (Already Selected)</option>
