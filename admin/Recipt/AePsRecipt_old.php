    ...
    <div class="receipt__holder">
        ...
        <img src="Logo/aeps.png" alt="AdminLTE Logo" class="rounded mx-auto d-block" width="110" style="float:right;">
            ...
            <div class="receipt__actions is-flex-centered is-print-hidden">
                <button onclick="history.go(-1);" class="button receipt__button">Back</button>
...
<div class="receipt">
    <div class="receipt__holder">
        <div class="receipt__headline">
            <h4 class="headline__title receipt__title">Mini Statment Receipt </h4>
        </div>
        <div class="receipt__paper">
            <div id="reciptid" class="receipt__info">
        <img src="../dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="rounded mx-auto d-block" width="90">
...
<div class="receipt">
    <div class="receipt__holder">
        <div class="receipt__headline">
            <h4 class="headline__title receipt__title">Balance Enquery Receipt </h4>
        </div>
        <div class="receipt__paper">
            <div id="reciptid" class="receipt__info">
        <img src="../dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="rounded mx-auto d-block" width="90">
...
<div class="receipt">
    <div class="receipt__holder">
        <div class="receipt__headline">
            <h4 class="headline__title receipt__title">Adhaar Pay Receipt </h4>
        </div>
        <div class="receipt__paper">
            <div id="reciptid" class="receipt__info">
        <img src="../dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="rounded mx-auto d-block" width="90">
