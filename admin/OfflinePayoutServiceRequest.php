  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Offline Payout Service Request</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Offline Payout Service Request</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Offline Payout Service Request</h3>
              </div>
              <!-- /.card-header -->
  ...
  <!-- Update Modal -->
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">EDIT UTR</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<script>
    ...
    var tod = $("#todate").val();
      $.ajax({
        url:"ajaxphp/payoutreport.php",
        method:"POST",
        data:{pageidd:6,formdate:fromd,todate:tod},
...
//             type : "POST",
//             data : {formdate:fromd,todate:tod,pageid:3},
...
<script>
    $(document).on("click",".remark", function(){
        ...
        var remark_id = $(this).data("cid");
        console.log(remark_id)
        $.ajax({
            url:"ajaxphp/payoutreport.php",
            type: "POST",
            data: {pageidd:301, xid:remark_id},
            success: function(data){
...
$(document).on("click",".update1",function(){
    ...
    $.ajax({
        url:"ajaxphp/payoutreport.php",
        type:"POST",
        data:{pageidd:1046, up_id:up_id, comment: comment},
        success: function(data){
            console.log(data);
            if (data==1){
                ...
                alert("Error There is something wrong at backend");
            }
        }
    });
