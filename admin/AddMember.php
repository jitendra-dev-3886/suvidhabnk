              ...
              <form method = "post" id="addmem">
                ...
                <div class="form-row d-flex justify-content-around">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" class="form-control" onkeypress="return this.value.length < 10;" name="mobile" placeholder="" required>
                      </div>
                 ...
                 <select class='selectpicker' aria-label="Default select example" id="aeps" style="width: 200px;" name="aepspack"  data-live-search="true" >
                      ...
                      <?php
                       while($aepsdt = mysqli_fetch_assoc($aeps)){
                             ...
                             if($aepsdt['PACKAGE_NAME']=="Default Package"){
                                 $a="selected";
                             }else{
                                 $a="";
                             }
                             echo "<option value = '{$aepsdt['ID']}' $slected $a>{$aepsdt['PACKAGE_NAME']}</option>";
                         }
                      ?>
                </select>
             </div>
                 ...
                 <select class='selectpicker' aria-label="Default select example" style="width: 200px;" name="dmtpack"  data-live-search="true" >
                      ...
                      while($dmtcomdt = mysqli_fetch_assoc($dmt)){
                        if($userdt['DMT_COMM'] == $dmtcomdt['ID']){
                          ...
                          if($dmtcomdt['PACKAGE_NAME']=="Default Package"){
                                 $a="selected";
                             }else{
                                 $a="";
                             }
                         echo "<option value = '{$dmtcomdt['ID']}' $slected $a>{$dmtcomdt['PACKAGE_NAME']}</option>";
                     }
                      ?>
                </select>
             </div>
                      ...
                      <?php
                          while($adharpaydata = mysqli_fetch_assoc($adharpay)){
                            if($userdt['AADHAR_COMM'] == $adharpaydata['ID']){
                             ...
                             if($adharpaydata['PACKAGE_NAME']=="Default Package"){
                                 $a="selected";
                             }else{
                                 $a="";
                             }
                              echo "<option value = '{$adharpaydata['ID']}' $slected $a>{$adharpaydata['PACKAGE_NAME']}</option>";
                         }
                      ?>              
                </select>
             </div>
                      ...
                      $comms = $con->query("SELECT * FROM commission_package WHERE SERVICES = 'Payout' ");
                          while($comdt = mysqli_fetch_assoc($comms)){
                            if($usermaincomdt["Payout"] == $comdt['ID']){
                             ...
                             if($comdt['PACKAGE_NAME']=="Default Package"){
                                 $a="selected";
                             }else{
                                 $a="";
                             }
                             echo "<option value = '{$comdt['ID']}' $slected $a>{$comdt['PACKAGE_NAME']}</option>";
                         }
                      ?>
                </select>
             </div>
