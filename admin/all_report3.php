                                                   ...
                                                   <table id="example" class="display " style="width:100%">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Distributor Opening Balance </th>
                                                                <th>Distributor Amount</th>
                                                                <th>Distributor Closeing Balance</th>
                                                                
                                                                <th>Master Distributor Opening Balance </th>
                                                                <th>Master Distributor Amount</th>
                                                                <th>Master Distributor Closeing Balance</th>
		        ...
		        success : function(data){
		          ...
		          $('#example').DataTable( {
                        ...
                        columns: [
                            ...
                            { data: 'Distributor_Opening_Balance' },
                            { data: 'Distributor_Amount' },
                            { data: 'Distributor Closeing_Balance' },
                            
                            { data: 'Master_Distributor_Opening_Balance' },
                            { data: 'Master_Distributor_Amount' },
                            { data: 'Master_Distributor_Closeing_Balance' },
