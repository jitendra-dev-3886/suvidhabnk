  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">AePs AdharPay Commission Setup</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form method="POST" id="aadharpay_Form">
    ...
    //  display...
      ...
      $('#dmtCom').click(function(e){ 
          e.preventDefault()
           ...
           {  
                $.ajax({  
                     url:"handler/AadharpayChargeSetup1.php",  
                     method:"POST",  
                     data:$('#aadharpay_Form').serialize(),  
                     success:function(data){ 
                         if(data==1){
                           alert('AadharpayCommissionSetup added successfully !');
                             location.reload();
                         }else{
...
$("#delete").click(function(){ 
    $.ajax({
        url: "handler/AadharpayChargeSetup.php",
        type: "POST",
        cache: false,
        data:{
            type:3,
