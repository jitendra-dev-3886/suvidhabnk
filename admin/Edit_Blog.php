...
$url_id = $_GET['id'];
$fetchBlog = $con->query("SELECT * FROM `blog` WHERE ID='$url_id'")->fetch_assoc();
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                   ...
                   <div class="form-row d-flex justify-content-around">
                       ...
                       <div class="form-group col-md-6">
                        ...
                        <select class="form-control select2" id="category" name="category" style="width: 100%;" value='<?php echo $fetchBlog['CATEGORIES']; ?>'>
                            <option>Select categories</option>           
                                <option selected value='<?php echo $fetchBlog['CATEGORIES']; ?>'><?php echo $fetchBlog['CATEGORIES']; ?></option>
                     ...
                     <div class="form-group col-md-6">
                            ...
                            <img src = 'assets/Blog/<?php echo $fetchBlog['IMAGE']; ?>' class='img-fluid' width='50px' />
                            <input type="file" class="form-control" name="image" id="image" value='<?php echo $fetchBlog['TITLE']; ?>'>
                        </div>
                     </div> 
                     <div class="form-row d-flex justify-content-around">
                       <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Title</label>
                            <input type="text" id="title" name="title" class="form-control"  value='<?php echo $fetchBlog['TITLE']; ?>'>
                       </div>
                       <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Written by</label>
                            <input type="text" id="writtenby" name="writtenby" class="form-control" placeholder="Written by" value='<?php echo $fetchBlog['WRITTEN_BY']; ?>'>
                       </div>
                     </div>
                  <div class="form-row d-flex justify-content-around">   
                     <div class="form-group col-md-6">
                    ...
                    <div class="form-row d-flex justify-content-around">   
                      <div class="form-group col-md-12">
                             <textarea id="summernote" name="richtext" id="richtext"> <?php echo $fetchBlog['RICH_TEXT']; ?>
                              </textarea>
                       </div>
                    </div>  
                ...
                <div class="card-footer d-flex justify-content-center">
                  <button type="submit" id="update_blog" name="update_blog" class="btn btn-primary">Update Blog</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
