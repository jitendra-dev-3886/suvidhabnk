...
if(isset($_POST['fund_transfer']) && $_POST['fund_transfer'] == 1){
// user data
...
$update_fund_report = $con->query("INSERT INTO `fund_transfer`(`MAIN_OWNER`, `MAIN_OWNER_ID`, `TOKEN_ID`, `OWNER_ID`, `TRANSFER_USER_ID`, `USER_PREVIOUS_AMOUNT`, `AMOUNT`, 
...
`COUNTRY`, `STATE`, `CITY`, `ZIP`, `LATTITUDE`, `LONGITUDE`, `API_IP`, `INTERNET_ISP`, `INTERNET_ORG`, `MESSAGE`,`WALLET_TYPE`,`REF_ID`) 

VALUES ('ADMIN','1','$token_id','1','$user_id','$user_aeps_bal','$amount','$add_user_bal','Credit','$admin_aeps_bal','$deduct_admin_bal','$remark','Success','$ip_address','$browser','$os','$device','$map_location','$trans_date','$trans_time','$country','$region','$city','$zip','$lat','$lon','$api_ip_address','$isp','$org','Credit User AePS Bal Successfully','AEPS_BAL','$reftype')");
...
$update_admin_wallet = $con->query("UPDATE `admin` SET `AEPS_BAL`='$deduct_admin_bal' WHERE ID='1'");
...
$update_fund_report = $con->query("INSERT INTO `fund_transfer`(`MAIN_OWNER`, `MAIN_OWNER_ID`, `TOKEN_ID`, `OWNER_ID`, `TRANSFER_USER_ID`, `USER_PREVIOUS_AMOUNT`, `AMOUNT`, `USER_AFTER_AMOUNT`, `FUND_TYPE`, `OWNER_PREVIOUS_AMOUNT`, `OWNER_AFTER_AMOUNT`, `REMARK`, `STATUS`, `IP_ADDRESS`, `BROWSER`, `OS`, `DEVICE`, `LOCATION`, `TRANS_DATE`, `TRANS_TIME`, `COUNTRY`, `STATE`, `CITY`, `ZIP`, `LATTITUDE`, `LONGITUDE`, `API_IP`, `INTERNET_ISP`, `INTERNET_ORG`, `MESSAGE`,`WALLET_TYPE`,`REF_ID`) 
VALUES ('ADMIN','1','$token_id','1','$user_id','$user_aeps_bal','$amount','$deduct_user_bal','Debit','$admin_aeps_bal','$add_admin_bal','$remark','Success','$ip_address','$browser','$os','$device','$map_location','$trans_date','$trans_time','$country','$region','$city','$zip','$lat','$lon','$api_ip_address','$isp','$org','Debit User AePS Bal Successfully','AEPS_BAL','$reftype')");
...
$update_admin_wallet = $con->query("UPDATE `admin` SET `AEPS_BAL`='$add_admin_bal' WHERE ID='1'");
...
$update_fund_report = $con->query("INSERT INTO `fund_transfer`(`MAIN_OWNER`, `MAIN_OWNER_ID`, `TOKEN_ID`, `OWNER_ID`, `TRANSFER_USER_ID`, `USER_PREVIOUS_AMOUNT`, `AMOUNT`, `USER_AFTER_AMOUNT`, `FUND_TYPE`, `OWNER_PREVIOUS_AMOUNT`, `OWNER_AFTER_AMOUNT`, `REMARK`, `STATUS`, `IP_ADDRESS`, `BROWSER`, `OS`, `DEVICE`, `LOCATION`, `TRANS_DATE`, `TRANS_TIME`, `COUNTRY`, `STATE`, `CITY`, `ZIP`, `LATTITUDE`, `LONGITUDE`, `API_IP`, `INTERNET_ISP`, `INTERNET_ORG`, `MESSAGE`,`WALLET_TYPE`,`REF_ID`)
VALUES ('ADMIN','1','$token_id','1','$user_id','$user_aeps_bal','$amount','$user_aeps_bal','Not Seleted Wallet Type','$admin_aeps_bal','$admin_main_bal','Failed Transaction','Failed','$ip_address','$browser','$os','$device','$map_location','$trans_date','$trans_time','$country','$region','$city','$zip','$lat','$lon','$api_ip_address','$isp','$org','illegal Transaction','AEPS_BAL','$reftype')");
...
if($deduct_admin_bal > 0){
$update_fund_report = $con->query("INSERT INTO `fund_transfer`(`MAIN_OWNER`, `MAIN_OWNER_ID`, `TOKEN_ID`, `OWNER_ID`, `TRANSFER_USER_ID`, `USER_PREVIOUS_AMOUNT`, `AMOUNT`, `USER_AFTER_AMOUNT`, `FUND_TYPE`, `OWNER_PREVIOUS_AMOUNT`, `OWNER_AFTER_AMOUNT`, `REMARK`, `STATUS`, `IP_ADDRESS`, `BROWSER`, `OS`, `DEVICE`, `LOCATION`, `TRANS_DATE`, `TRANS_TIME`, `COUNTRY`, `STATE`, `CITY`, `ZIP`, `LATTITUDE`, `LONGITUDE`, `API_IP`, `INTERNET_ISP`, `INTERNET_ORG`, `MESSAGE`,`WALLET_TYPE`,`REF_ID`) 
VALUES ('ADMIN','1','$token_id','1','$user_id','$user_main_bal','$amount','$add_user_bal','Credit','$admin_main_bal','$deduct_admin_bal','$remark','Success','$ip_address','$browser','$os','$device','$map_location','$trans_date','$trans_time','$country','$region','$city','$zip','$lat','$lon','$api_ip_address','$isp','$org','Credit User Main Bal Successfully','MAIN_BAL','$reftype')");
...
$update_admin_wallet = $con->query("UPDATE `admin` SET `MAIN_BAL`='$deduct_admin_bal' WHERE ID='1'");
...
if($deduct_user_bal > 0){
$update_fund_report = $con->query("INSERT INTO `fund_transfer`(`MAIN_OWNER`, `MAIN_OWNER_ID`, `TOKEN_ID`, `OWNER_ID`, `TRANSFER_USER_ID`, `USER_PREVIOUS_AMOUNT`, `AMOUNT`, `USER_AFTER_AMOUNT`, `FUND_TYPE`, `OWNER_PREVIOUS_AMOUNT`, `OWNER_AFTER_AMOUNT`, `REMARK`, `STATUS`, `IP_ADDRESS`, `BROWSER`, `OS`, `DEVICE`, `LOCATION`, `TRANS_DATE`, `TRANS_TIME`, `COUNTRY`, `STATE`, `CITY`, `ZIP`, `LATTITUDE`, `LONGITUDE`, `API_IP`, `INTERNET_ISP`, `INTERNET_ORG`, `MESSAGE`,`WALLET_TYPE`,`REF_ID`) 
VALUES ('ADMIN','1','$token_id','1','$user_id','$user_main_bal','$amount','$deduct_user_bal','Debit','$admin_main_bal','$add_admin_bal','$remark','Success','$ip_address','$browser','$os','$device','$map_location','$trans_date','$trans_time','$country','$region','$city','$zip','$lat','$lon','$api_ip_address','$isp','$org','Debit User AePS Bal Successfully','MAIN_BAL','$reftype')");
...
$update_admin_wallet = $con->query("UPDATE `admin` SET `MAIN_BAL`='$add_admin_bal' WHERE ID='1'");
...
$update_fund_report = $con->query("INSERT INTO `fund_transfer`(`MAIN_OWNER`, `MAIN_OWNER_ID`, `TOKEN_ID`, `OWNER_ID`, `TRANSFER_USER_ID`, `USER_PREVIOUS_AMOUNT`, `AMOUNT`, `USER_AFTER_AMOUNT`, `FUND_TYPE`, `OWNER_PREVIOUS_AMOUNT`, `OWNER_AFTER_AMOUNT`, `REMARK`, `STATUS`, `IP_ADDRESS`, `BROWSER`, `OS`, `DEVICE`, `LOCATION`, `TRANS_DATE`, `TRANS_TIME`, `COUNTRY`, `STATE`, `CITY`, `ZIP`, `LATTITUDE`, `LONGITUDE`, `API_IP`, `INTERNET_ISP`, `INTERNET_ORG`, `MESSAGE`,`WALLET_TYPE`,`REF_ID`)VALUES ('ADMIN','1','$token_id','1','$user_id','$user_aeps_bal','$amount','$user_aeps_bal','Not Seleted Wallet Type','$admin_main_bal','$admin_main_bal','Failed Transaction','Failed','$ip_address','$browser','$os','$device','$map_location','$trans_date','$trans_time','$country','$region','$city','$zip','$lat','$lon','$api_ip_address','$isp','$org','illegal Transaction','MAIN_BAL','$reftype')");
...
$update_admin_wallet = $con->query("UPDATE `admin` SET `AEPS_BAL`='$update_admin_bal' WHERE ID='1'");
...
$update_admin_wallet = $con->query("UPDATE `admin` SET `MAIN_BAL`='$update_admin_bal' WHERE ID='1'");
