...
include('../../Db/config.php');
 ...
 {  
      ...
      if(mysqli_query($con, $query))  
            {  
           echo '<script type="text/javascript">alert("MoneyTransferChargeSetup Created")  
           location.replace("MoneyTransferChargeSetup.php?pack_id='.$packid.'")
                 </script>';

      }else{
           echo '<script type="text/javascript">alert("Failed to Create MoneyTransferChargeSetup")  
             location.replace("MoneyTransferChargeSetup.php")
                 </script>';
