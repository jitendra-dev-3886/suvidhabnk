...
$com_pack_id= $_POST['pid'];
 ...
 if($res->num_rows >0){
    ...
    <td>
    <a href='DMTChargeSetup1.php?rid={$row['ID']}' class='fas fa-edit'></a>&nbsp<a href='#deleteEmployeeModal' class='delete' data-id='{$row['ID']}' data-toggle='modal'><i class='fas fa-trash'></i></a></td>
    </tr>";
