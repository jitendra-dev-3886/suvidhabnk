...
include('../../Db/config.php');
 ...
 {  
    ...
    //   echo "UPDATE `slab_commission` SET `MIN_AMOUNT`='$start_range',`MAX_AMOUNT`='$end_range',`TDS`='$tds',`GST`='$gst',`TYPE`='$comm_type',`AMOUNT`='$retailer_comm',`CHARGE`='$charges',`DS_COM`='$distributor_comm',`MS_COM`='$ms_comm' WHERE ID='$packid'";
    // 
      $update=$con->query("UPDATE `slab_commission` SET `MIN_AMOUNT`='$start_range',`MAX_AMOUNT`='$end_range',`TDS`='$tds',`GST`='$gst',`TYPE`='$comm_type',`AMOUNT`='$retailer_comm',`CHARGE`='$charges',`DS_COM`='$distributor_comm',`MS_COM`='$ms_comm' WHERE ID='$packid'");
