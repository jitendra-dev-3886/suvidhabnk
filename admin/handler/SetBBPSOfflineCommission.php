...
include('../../Db/config.php');
 ...
 {  
      ...
      if(mysqli_query($con, $query))  
            {  
           echo '<script type="text/javascript">alert("BBPS offline Commission Created")  
           location.replace("SetBBPSOfflineBBPSCommission.php?pack_id='.$packid.'")
</script>';

      }else{
           echo '<script type="text/javascript">alert("Failed to Create BBPS Offline commission")  
             location.replace("SetBBPSOfflineBBPSCommission.php")
</script>';
