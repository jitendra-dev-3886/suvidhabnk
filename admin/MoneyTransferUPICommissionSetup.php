  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Money Transfer UPI Commission Setup</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Money Transfer UPI Commission Setup</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
                ...
                <h3 class="card-title">Money Transfer UPI Commission Setup</h3>
              </div>
              <!-- /.card-header -->
              <form method = "post" id="moneyTransfer">
                <div class="card-body">
               <div class="form-row d-flex justify-content-around ">
                ...
                <div class="card-footer d-flex justify-content-center">
                  <input type="hidden" value="1" name="upi_type">
...
<div class="card-body">
                ...
                <div class="form-row d-flex justify-content-around ">
                    <div class="form-group col-md-6">
                      ...
                      <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">Name</label>
                        <input type="text" class="form-control" name="COMPANY_NAME" id="COMPANY_NAME" placeholder="Name" required>
                      </div>
                      <div class="card-footer d-flex justify-content-center">
  ...
  $(document).ready(function(){
        //   display
           function loadData()
             {
                $.ajax({
                url: "handler/MoneyTransferUpi.php",
                type: "POST",
                data : {id:1},
                success: function(data){
                    $("#transferupi").html(data);
                }
            });
          }
        loadData();
