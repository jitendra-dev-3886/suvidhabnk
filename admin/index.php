...
<a href="MainWalletReport.php">
              <div class="info-box-content">
                ...
                //   echo number_format($total_main['SUM(MAIN_BAL)'] ,2);
                 $total_main = $con->query("SELECT  * FROM `admin`")->fetch_assoc();
                 echo number_format($total_main['MAIN_BAL'] ,2);
                 ?>
...
<a href="AePsWalletReport.php">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <!--<span class="info-box-number">Retailer | Distributor | MasterDistributor</span>-->
                <!--old query-->
        <!--         //?php-->
			    	<!--$sql = "SELECT * FROM `user` where USER_TYPE='46'";-->
			    	<!--$dist = $con->query("SELECT * FROM `user` where USER_TYPE='47'")->num_rows;-->
			    	<!--$mas_dist = $con->query("SELECT * FROM `user` where USER_TYPE='48'")->num_rows;-->
        ...
        <!--                 }-->
        <!--       ?>-->
        <!--        <span class="info-box-number">  <a href="RetailerList.php">R - <?php echo $rowcount; ?></a> | <a href="Distributor_List">D - <?php echo $dist; ?> </a> | <a href="MasterDistList"> M - <?php echo $mas_dist; ?> </a></span>-->
        
        <!--new and updated query-->
        <?php
            // Count retailers
            $retailers = $con->query("SELECT COUNT(*) as count FROM `user` WHERE USER_TYPE='46'")->fetch_assoc();
            $retailerCount = $retailers['count'];
        
            // Count distributors
            $distributors = $con->query("SELECT COUNT(*) as count FROM `user` WHERE USER_TYPE='47'")->fetch_assoc();
            $distributorCount = $distributors['count'];
        
            // Count master distributors
            $masterDistributors = $con->query("SELECT COUNT(*) as count FROM `user` WHERE USER_TYPE='48'")->fetch_assoc();
            $masterDistributorCount = $masterDistributors['count'];
        ?>

            <span class="info-box-number">
                <a href="RetailerList.php">R - <?php echo $retailerCount; ?></a> | 
                <a href="Distributor_List">D - <?php echo $distributorCount; ?> </a> | 
                <a href="MasterDistList"> M - <?php echo $masterDistributorCount; ?> </a>
            </span>
            ...
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                   ...
                   //new query
                   echo $con->query("SELECT COUNT(DISTINCT USER_ID) as count FROM login_history WHERE USER_ID <> '' AND DATE(LOGIN_DATE) = CURDATE()")->fetch_assoc()['count'];
                   
                 //  echo "SELECT COUNT(DISTINCT USER_ID) as count FROM login_history WHERE USER_ID <> '' AND DATE(LOGIN_DATE) = CURDATE()";
         ...
         <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php
                   $tdate = date("Y-m-d");
                   $todayrc = $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamt FROM `recharge_transaction` WHERE date(FILTER_DATE) = '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                ...
                //   echo $mdate; 
                //   echo $tdate;
                   $mdayrc= $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamtmo FROM `recharge_transaction` WHERE date(FILTER_DATE) between '$mdate' AND '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                   ?><b style="float:right">₹<?php echo $mdayrc['tamtmo'];?></b></span>
                <span class="info-box-number">Yearly <?php
                   
                   $ydate = date("Y-m-d",strtotime("-1 year"));
                //   echo $ydate;
                $ydayrc= $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamtyea FROM `recharge_transaction` WHERE date(FILTER_DATE) between '$ydate' AND '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
         ...
         <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php
                   $tdate = date("Y-m-d");
                $todayaeps = $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamt FROM aeps_transactions WHERE TRANS_TYPE='CW' AND STATUS='Success,AEPS Transaction Success' AND date(FILTER_DATE) = '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();                   
                ...
                //   echo $mdate; 
                //   echo $tdate;
                   $mdayrc= $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamtmo FROM `aeps_transactions` WHERE TRANS_TYPE='CW' AND STATUS='Success,AEPS Transaction Success' AND date(FILTER_DATE) between '$mdate' AND '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                   ?><b style="float:right">₹<?php echo $mdayrc['tamtmo'];?></b></span>
                <span class="info-box-number">Yearly <?php
                   
                   $ydate = date("Y-m-d",strtotime("-1 year"));
                //   echo $ydate;
                $ydayrc= $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamtyea FROM `aeps_transactions` WHERE TRANS_TYPE='CW' AND STATUS='Success,AEPS Transaction Success' AND date(FILTER_DATE) between '$ydate' AND '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();                   
                ?><b style="float:right">₹<?php echo $ydayrc['tamtyea'];?></b></span>
              </div>
             <!--<i class="fas fa-users"></i>-->
             <!-- <i class="fas fa-users">-->
         ...
         <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php
                   $tdate = date("Y-m-d");
                $todayaeps = $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamt FROM aeps_transactions WHERE TRANS_TYPE='M' AND STATUS='Success,AEPS Transaction Success' AND date(FILTER_DATE) = '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                   ?>Today <b style="float:right">₹<?php echo $todayaeps['tamt']; ?></b></span>
                <span class="info-box-number">Monthly <?php
                ...
                //   echo $mdate; 
                //   echo $tdate;
                   $mdayrc= $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamtmo FROM `aeps_transactions` WHERE TRANS_TYPE='M' AND STATUS='Success,AEPS Transaction Success' AND date(FILTER_DATE) between '$mdate' AND '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                   ?><b style="float:right">₹<?php echo $mdayrc['tamtmo'];?></b></span>
                <span class="info-box-number">Yearly<?php
                   
                   $ydate = date("Y-m-d",strtotime("-1 year"));
                //   echo $ydate;
                $ydayrc= $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamtyea FROM `aeps_transactions` WHERE TRANS_TYPE='M' AND STATUS='Success,AEPS Transaction Success' AND date(FILTER_DATE) between '$ydate' AND '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                   ?><b style="float:right">₹<?php echo $ydayrc['tamtyea'];?></b></span>
              </div>
             <!--<i class="fas fa-users"></i>-->
             <!-- <i class="fas fa-users">-->
         ...
         <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php
                   $tdate = date("Y-m-d");
                 $total_aeps = $con->query("SELECT  FORMAT(IFNULL(SUM(AMOUNT),0),2)pay FROM `pay_bill_api` WHERE date(FILTER_DATE) = '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                ...
                //   echo $mdate; 
                //   echo $tdate;
                   $mdayrc= $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamtmo FROM `pay_bill_api` WHERE date(FILTER_DATE) between '$mdate' AND '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                   ?><b style="float:right">₹<?php echo $mdayrc['tamtmo'];?></b></span>
                <span class="info-box-number">Yearly<?php
                   
                   $ydate = date("Y-m-d",strtotime("-1 year"));
                //   echo $ydate;
                $ydayrc= $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamtyea FROM `pay_bill_api` WHERE date(FILTER_DATE) between '$ydate' AND '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                   ?><b style="float:right">₹<?php echo $ydayrc['tamtyea'];?></b></span>
              </div>
             <!--<i class="fas fa-users"></i>-->
             <!-- <i class="fas fa-users">-->
         ...
         <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php
                   $tdate = date("Y-m-d");
                 $todaydmt = $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamt FROM dmt_transactions WHERE date(TIMESTAMP) = '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                ...
                //   echo $mdate; 
                //   echo $tdate;
                   $mdayrc= $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamtmo FROM `dmt_transactions` WHERE date(TIMESTAMP) between '$mdate' AND '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                   ?><b style="float:right">₹<?php echo $mdayrc['tamtmo'];?></b></span>
                <span class="info-box-number">Yearly<?php
                   
                   $ydate = date("Y-m-d",strtotime("-1 year"));
                //   echo $ydate;
                $ydayrc= $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamtyea FROM `dmt_transactions` WHERE date(TIMESTAMP) between '$ydate' AND '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                   ?><b style="float:right">₹<?php echo $ydayrc['tamtyea'];?></b></span>
              </div>
             <!--<i class="fas fa-users"></i>-->
             <!-- <i class="fas fa-users">-->
         ...
         <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php
                   $tdate = date("Y-m-d");
                   $todaypayout = $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamt FROM payout_transaction WHERE STATUS ='ACCEPTED' AND FILTER_DATE = '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                ...
                //   echo $mdate; 
                //   echo $tdate;
                   $mdayrc= $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamtmo FROM `payout_transaction` WHERE STATUS ='ACCEPTED' AND date(FILTER_DATE) between '$mdate' AND '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                   ?><b style="float:right">₹<?php echo $mdayrc['tamtmo'];?></b></span>
                <span class="info-box-number">Yearly<?php
                   
                   $ydate = date("Y-m-d",strtotime("-1 year"));
                //   echo $ydate;
                $ydayrc= $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamtyea FROM `payout_transaction` WHERE STATUS ='ACCEPTED' AND date(FILTER_DATE) between '$ydate' AND '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                   ?><b style="float:right">₹<?php echo $ydayrc['tamtyea'];?></b></span>
              </div>
             <!--<i class="fas fa-users"></i>-->
             <!-- <i class="fas fa-users">-->
         ...
         <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php
                   $tdate = date("Y-m-d");
                 $total_aeps = $con->query("SELECT  FORMAT(IFNULL(SUM(AMOUNT),0),2)pan FROM `pan_transaction` WHERE date(DATE) = '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                ...
                //   echo $mdate; 
                //   echo $tdate;
                   $mdayrc= $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamtmo FROM `pan_transaction` WHERE date(DATE) between '$mdate' AND '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                   ?><b style="float:right">₹<?php echo $mdayrc['tamtmo'];?></b></span>
                <span class="info-box-number">Yearly<?php
                   
                   $ydate = date("Y-m-d",strtotime("-1 year"));
                //   echo $ydate;
                $ydayrc= $con->query("SELECT FORMAT(IFNULL(SUM(AMOUNT),0),2)tamtyea FROM `pan_transaction` WHERE date(DATE) between '$ydate' AND '$tdate' AND `STATUS` LIKE '%Success%'")->fetch_assoc();
                   ?><b style="float:right">₹<?php echo $ydayrc['tamtyea'];?></b></span>
              </div>
             <!--<i class="fas fa-users"></i>-->
             <!-- <i class="fas fa-users">-->
