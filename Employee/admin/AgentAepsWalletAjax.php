...
$output .= "<div class='form-row d-flex justify-content-around '>
                    <div class='form-group col-md-5'>
                        ...
                        <input type readonly='readonly' class='form-control' value= '{$row['FIRST_NAME']}' name='agent_naame' id='agent_naame' placeholder=''>
                      </div>
                    <div class='form-group col-md-5'>
                        <label for='exampleInputEmail1'>Agent Remaning Balance</label>
                        <input type readonly='readonly' class='form-control'  value ='{$row['AEPS_BAL']}' name='bal' id='bal' placeholder=''>
                    </div>
                </div>
                <div class='form-row d-flex justify-content-around '>
                    <div class='form-group col-md-5'>
                        <label for='exampleInputEmail1'>Agent Type</label>
                        <input type readonly='readonly' class='form-control'  value='{$usertype['NAME']}' name='type' id='type' placeholder=''>
                      </div>
                    <div class='form-group col-md-5'>
                        <label for='exampleInputEmail1'>Agent Owner Name</label>
                        <input type readonly='readonly' class='form-control'  value='$ownername' name='o_name' id='o_name' placeholder=''>
                    </div>
                </div>
