          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Retailer Transfer</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Distributor Transfer</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post">
                ...
                <div class="form-row d-flex justify-content-around">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        ?>
                         <select id="utrell" class="form-control select2" style="width: 100%;">
                             <option selected disabled>Select Distributor</option>
                            <?php
                            while($row = $sql->fetch_assoc()){
                    ...
                    <div class="form-group col-md-6">
                        ...
                        $sql1 = $con->query("SELECT * FROM user WHERE USER_TYPE = '48'");
                       
                        
                        ?>
                        
                         <select id="utdistt" class="form-control select2" style="width: 100%;">
                             <option selected disabled>Select Master Distributor</option>
                             <?php
                            while($row1 = $sql1->fetch_assoc()){
                ...
                <div class="card-footer d-flex justify-content-center">
                  <button type="submit" id="utbtnn" class="btn btn-primary">Update</button>
                </div>
              </form>
            </div>
...
$(document).ready(function(){
    ...
    $("#utrel").on("change",function(){
        ...
        $.ajax({
            url : "ajaxphp/user_transfer1.php",
            method : "POST",
...
$(document).ready(function(){
    ...
    $("#utrell").on("change",function(){
        var reluser = $(this).val();
        $.ajax({
            url : "ajaxphp/user_transfer1.php",
            method : "POST",
            data : {rtuserr:reluser,pageid:3},
            success : function(response){
                $("#trdistt").html(response);
            }
        });
    });
    
    
     $("#utbtnn").click(function(e){
         e.preventDefault();
        var reluser = $("#utrell").val();
        var distuser = $("#utdistt").val();
        $.ajax({
            url : "ajaxphp/user_transfer1.php",
            method : "POST",
            data : {rtuserr:reluser,dtuserr:distuser,pageid:4},
            success : function(response){
                if(response == 1){
                    alert("User Transfer Successfull..");
                }else{
