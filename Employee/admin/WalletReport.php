          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo $_GET['type'] ?> Wallet Report Data Table</h3>
              </div>
               <div class="row">
...
<script>
    ...
    var tod = $("#todate").val();
      $.ajax({
        ...
        method:"POST",
        data:{pageid:2 , id:'<?php echo $_GET['id'] ?>' , type:'<?php echo $_GET['type'] ?>', formdate:fromd,todate:tod},
...
//             type : "POST",
//             data : {formdate:fromd,todate:tod,pageid:5 ,id: '<?php echo $_GET['id'] ?>' , type: '<?php echo $_GET['type'] ?>'},
