  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">M-ATM Purchase Request</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">M-ATM Purchase Request</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">M-ATM Purchase Request Data Table</h3>
              </div>
            ...
            success:function(data){
                if(data == 1){
                    Swal.fire({
                      ...
                      location.replace("https://paydeer.in/admin/M-ATMRequest.php");
            });
...
$(document).on("click", "#update",function(){
  ...
  $.ajax({
     url:"handler/M-ATM_Report.php",
     type:'POST',
     data :{id:7,updates_id:up_id,update_status:update_status},
     success: function(data){
         if(data == 1){
                    Swal.fire({
                      icon: "success",
