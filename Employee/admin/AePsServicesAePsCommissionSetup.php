              ...
              <form method="post" id="aepssetup">
               ...
               <div class="form-row d-flex justify-content-around ">
                ...
                <div class="card-footer d-flex justify-content-center">
                   <input type="hidden" value="1" name="aeps_type">
                  <button type="submit" id="aeps_save" class="btn btn-primary">Set Commission Setup</button>
                </div>
                </form>
                </div>
                  <!-- /.card-body -->
