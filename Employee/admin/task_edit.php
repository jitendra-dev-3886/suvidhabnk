        ...
        while($row = mysqli_fetch_assoc($res)){
            $output .= "
              ...
              <div class='form-group'>
                   <lable>Update Task:</lable>
                   <input type='text' name='update_task' id='update_task' class='form-control' value='{$row['TASK']}'>
           ...
           <div class='form-group'>
                   <lable>Update Rich Text:</lable>
                   <textarea id='summernote' name='richtext' id='richtext' class='form-control' value='{$row['RICH_TEXT']}'>
              </textarea>
           </div>
