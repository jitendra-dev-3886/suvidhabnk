          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <table id="example1" class="table table-bordered table-striped">
               <thead>
                  <tr>
                     <th>Server Name/Partner Name</th>
                     <th>Switch</th>
                     <!--<th>Shift Area</th>-->
                  </tr>
               </thead>
               <tbody>
                  <tr>
                     ...
                     <td><span>OFF</span>
                        <label class="switch">
                        <input type="checkbox" name="recharge" value='ON' <?php echo ($srst['RECHARGE'] == "ON") ? "checked" : "" ?>>
                  ...
                  <tr>
                     ...
                     <td><span>OFF</span>
                        <label class="switch">
                        <input type="checkbox" name="aeps" value='ON' <?php echo ($srst['AEPS'] == "ON") ? "checked" : "" ?>>
                        <span class="slider round"></span>
                        </label>
                        <span>ON</span>
                     </td>
                  ...
                  <tr>
                     ...
                     <td><span>OFF</span>
                        <label class="switch">
                        <input type="checkbox" name="dmt" value='ON' <?php echo ($srst['DMT'] == "ON") ? "checked" : "" ?>>
                        <span class="slider round"></span>
                        </label>
                        <span>ON</span>
                     </td>
                  ...
                  <!--   <td><span>OFF</span>-->
                  <!--      <label class="switch">-->
                  <!--      <input type="checkbox" name="xdmt" value='ON' <?php echo ($srst['XDMT'] == "ON") ? "checked" : "" ?>>-->
                  <!--      <span class="slider round"></span>-->
                  <!--      </label>-->
                  <!--      <span>ON</span>-->
                  <!--   </td>-->
                  ...
                  <tr>
                     ...
                     <td><span>OFF</span>
                        <label class="switch">
                        <input type="checkbox" name="payout" value='ON' <?php echo ($srst['PAYOUT'] == "ON") ? "checked" : "" ?>>
                        <span class="slider round"></span>
                        </label>
                        <span>ON</span>
                     </td>
                  ...
                  <tr>
                     ...
                     <td><span>OFF</span>
                        <label class="switch">
                        <input type="checkbox" name="upi" value='ON' <?php echo ($srst['UPI'] == "ON") ? "checked" : "" ?>>
                        <span class="slider round"></span>
                        </label>
                        <span>ON</span>
                     </td>
                  ...
                  <tr>
                     ...
                     <td><span>OFF</span>
                        <label class="switch">
                        <input type="checkbox" name="pan" value='ON' <?php echo ($srst['PAN'] == "ON") ? "checked" : "" ?>>
                        <span class="slider round"></span>
                        </label>
                        <span>ON</span>
                     </td>
                  ...
                  <tr>
                     ...
                     <td><span>OFF</span>
                        <label class="switch">
                        <input type="checkbox" name="insurance" value='ON' <?php echo ($srst['INSURANCE'] == "ON") ? "checked" : "" ?>>
                        <span class="slider round"></span>
                        </label>
                        <span>ON</span>
                     </td>
                  ...
                  <tr>
                     ...
                     <td><span>OFF</span>
                        <label class="switch">
                        <input type="checkbox" name="bbps" value='ON' <?php echo ($srst['BBPS'] == "ON") ? "checked" : "" ?>>
                        <span class="slider round"></span>
                        </label>
                        <span>ON</span>
                     </td>
