  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Distributor Appointment Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Distributor Appointment Report</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Distributor Appointment Table</h3>
              </div>
              <!-- /.card-header -->
...
<script>
    ...
    var tod = $("#todate").val();
      $.ajax({
        url:"handler/Distributor_Appoinment.php",
        method:"POST",
...
$.ajax({
        url:"distributor_Appointment_delete.php",
        type:"POST",
        data:{id:teamid},
        success:function(data){
     ...
     if(data==1){
          Swal.fire({
              icon: 'success',
              title: 'Delete Distributor Appointment  successful..',
              button: 'Okay'
             }).then(function(){
                      location.replace('Distributor Appointment Record.php');
             });
        }else{
             Swal.fire({
              icon: 'error',
              title: 'Delete Distributor Appointment Unsuccessful..',
              button: 'Okay'
             }).then(function(){
                      location.replace('Distributor Appointment Record.php');
             });
...
<script>
  ...
  $.ajax({
      url : "Distributor_Appointment_Status_edit.php",
      type : 'POST',
      data : {pageid:8,eid:edit_id},
      success : function(data){
