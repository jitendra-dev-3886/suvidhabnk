...
error_reporting(0);
    ...
    $fth_data = json_decode($static_bbps['FETCH_RESPONSES'],true);
          ...
          <div class="container">
               <div class="row d-flex justify-content-center" >
                   <div class="col-sm-11 btns mb-3">
                       ...
                       <button onclick="javascript:location.replace('../BBPSOnlineBBPSServiceReport')" class="btn btn-danger" id="goBack"><i class="fas fa-print"></i> Go Back</button>
                   </div>
                    ...
                    <div class="col-11">
                         <div class="table-responsive" id="reciept-table">
                              ...
                              <table class="table table-bordered">
                                   <thead>
                                        <tr>
                                            <th colspan="4" class="">Transaction Date : <?php echo $static_bbps['FILTER_DATE'] ?></th>
                                        </tr>
                                   </thead>
                                   <tbody>
                                          <tr>
                                        ...
                                        <tr>
                                              <td colspan="1" style="font-size: 12px;">Category: <?php echo $static_bbps['CATEGORY'] ?></td>
                                              <td colspan="1" style="font-size: 12px;">Consumer Number : <?php echo $static_bbps['CA_NUM'] ?></td>
                                              <td colspan="1" style="font-size: 12px;">Service Provider : <?php echo $static_bbps['OP_NAME'] ?></td>
                                              <td colspan="1" style="font-size: 12px;">Consumer Name : <?php echo $conname ?></td>
                                        </tr>
