                    ...
                    <div class="col-11">
                         <div class="table-responsive" id="reciept-table">
                              ...
                              <table class="table table-bordered">
                                   ...
                                   <tbody>
                                          <tr>
                                             <td>Merchant Name: <?php echo $report['name']; ?></td>
                                        ...
                                        <tr>
                                              ...
                                              <td colspan="2" style="font-size:12px;">BANK RRN : <?php echo $report['bankrrn'] ?></td>
                                        </tr>
                    ...
                    <div class="col-11">
                         ...
                         <div class="table-responsive" id="reciept-table">
                              ...
                              <table class="table table-bordered">
                                   ...
                                   <tbody>
                                          <tr>
                                             <td colspan="2">Merchant Name: <?php echo $report['name']; ?></td>
                              ...
                              <table class="table table-bordered">
                                   ...
                                   <tbody>
                                       ...
                                       <?php  } ?>
                                        <tr class="tfooter">
                                             <td colspan="6">
                                                  <span class="fw-bold">Total Amount Rs. : <?php echo $totl ?> /- </span>
                                                  <!--<h6>Amount in Words : Five Thousand Fourty Only.</h6>-->
                              ...
                              <table class="table table-bordered">
                                   ...
                                   <tbody>
                                        ...
                                        <tr>
                                              ...
                                              <td class="p-0  mx-1" colspan="2">Bank Rrn: <?php echo $report['bankrrn'] ?></td>
                                        </tr>
