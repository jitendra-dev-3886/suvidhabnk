...
include('../../Db/config.php');
 ...
 {  
      ...
      VALUES ('ADMIN','1','1','1','$packid','$start_range','$end_range','$tds','$gst','$comm_type','CREDIT','$retailer_comm','0','$charges','$distributor_comm','$ms_comm')";  
      if(mysqli_query($con, $query))  
            {  
           echo '<script type="text/javascript">alert(" ChargeSetup Created")</script>';

      }else{
           echo '<script type="text/javascript">alert("Failed to Create ChargeSetup")</script>';
