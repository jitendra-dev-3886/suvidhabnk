                  ...
                  <div class="pcoded-content">
                    ...
                    <div class="pcoded-inner-content">
                      ...
                      <div class="main-body">
                        ...
                        <form method="post" id="visitingform" >
                             ...
                             <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <select  name="lead_status" id="lead_status" class="form-control" onchange="changeCom(this.value)">
                                    ...
                                    <option value="Full Payment Recive">Full Payment Recive</option>
                                    <option value="Next Call">Next Call</option>
                          ...
                          <div class="text-center">
                            ...
                            <div class="text-center">
                            <input type="submit" name='visitingbtn' id="submitLead" class="btn btn-info" value="submit"/>
                          </div>
...
function popup(status , title , msg){
  ...
  $(document).ready(function () {
    ...
    $('#visitingform').submit(function (e) {
        e.preventDefault();
        if($("#fname").val() == ""){
            ...
            if(data==1)
                {
                    Swal.fire({
  title: "Success!",
  text: "Visiting Added Successfully..!",
  icon: "success",
  button: "Okay",
}).then(() => {
    $("#visitingform").trigger('reset');
});
