...
$recipt = $con->query("SELECT * FROM xdmt_transactions WHERE REFFRENCE_ID = '$refrence'")->fetch_assoc();
...
<div class="receipt">
    <div class="receipt__holder">
        <div class="receipt__headline">
            <h4 class="headline__title receipt__title">XDMT Receipt </h4>
        </div>
        ...
        <img src="../../assets/images/<?php echo $row['I_LOGO']?>" alt="AdminLTE Logo" class="rounded mx-auto d-block" width="90" style="margin-top: -15px;">
            ...
            <div class="receipt__actions is-flex-centered is-print-hidden">
                <button  onclick="javascript:location.replace('../MoneyTransferXDMTReport')" class="button receipt__button">Back</button>
