...
$refrence =  "NSD".$usid.$txn_type.date("ds").mt_rand(999 , 9999);
 
 $comonRefID =   "NSD".$usid.$txn_type.date("ds").mt_rand(9999 , 99999);
            ...
            $curl = curl_init();
              $data = json_encode(
                ...
                curl_close($curl);
                  ...
                  $con->query("update dmt_transactions set RESPONSE='".str_replace("'" , "\'" , $response)."'  , STATUS='$st_msg' where REFFRENCE_ID='$refrence' ");
                   if(($rs_code != 1 || $status == 0 ) && $response != ""){
