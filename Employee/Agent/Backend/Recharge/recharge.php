...
curl_close($curl);
    ...
    //   exit;
      ...
      if($status == "Failed"){
        ...
        $usermb = substr($user['MOBILE'] , 7 , 10);
         $mbmsg = urlencode("INR $sndam has been Credited from your NsdPay.in A/C No *******$usermb  towards Recharge Refund Txn. $refrence. Main Wallet Avl BAL is INR $usbl. Team NsdPay");
