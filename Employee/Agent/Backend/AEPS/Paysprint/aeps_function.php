...
function give_aeps_com($ref_id , $user_id , $usertype){
        ...
        insert_allreport($ds_id  ,$ref_id , "AEPS Commission" ,$ds_aeps_bal , $ds_update_bal , $ds_givenCom , $pack['AMOUNT_TYPE'] , "AEPS Transaction Commission" , "AEPS");
...
function aadhar_com($ref_id , $user_id , $usertype){
        ...
        // Insert All Report
        insert_allreport($user_id  ,$ref_id , "ADHAAR_PAY Charge" ,$us_main_bal , $crnt_bal , $charge_amount , "Debit" , "ADHAAR_PAY Transaction Charge", "MAIN");
        $con->query("update user set MAIN_BAL='$update_bal'  where ID='$user_id' ");
