  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Broadband BBPS Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Broadband BBPS Report</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Broadband BBPS Report Data Table</h3>
              </div>
              <!-- /.card-header -->
...
<script>
    ...
    function load_data()
    {
      $.ajax({
        ...
        method:"POST",
        data:{category:"Broadband",pageid:3},
    ...
    var tod = $("#todate").val();
        ...
        $.ajax({
            url : "handler/BBPS_Report.php",
            type : "POST",
            data : {formdate:fromd,todate:tod,category:"Broadband",pageid:4},
