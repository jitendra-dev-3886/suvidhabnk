...
include("Backend/AEPS/Paysprint/aeps_function.php"); // aeps use
 ...
 if(isset($_GET['MyLatestReport'])){
        $rep =  $con->query("SELECT * FROM `recharge_transaction` where USER_ID='$usid' order by ID Desc LIMIT 1")->fetch_assoc();
        $repId = $rep['REFERENCE_ID'];
        header("location: Recipt/RechargeRecipt?refrence_id=$repId&service=DTH");
    }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">DTH Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">DTH Report</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DTH Report Data Table</h3>
              </div>
               <div class="row">
...
<script>
    ...
    var tod = $("#todate").val();
      $.ajax({
        ...
        method:"POST",
        data:{pageid:4,type:"10",formdate:fromd,todate:tod},
