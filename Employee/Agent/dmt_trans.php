                                                                        ...
                                                                        <input type="hidden" id="str_code" name="str">
                                                                            <div class="form-row mt-4 d-flex justify-content-center">
                                                                                ...
                                                                                <div class="col-md-3" id="submit_btn_area" style="display:none">
                                                                                    <button type="button" id="register_user" class="btn waves-effect waves-light btn-primary btn-block btn-outline-primary"><i class="ti-mobile"></i>Register Now</button>
                                                                                </div>
                                                    ...
                                                    <div class="card-block table-border-style">
                                                        <div class="table-responsive">
                                                            <table class="table table-striped" id="example" class="display" style="width:100%">
                                                              ...
                                                              <tbody> 
                                                              <?php
                                                                  $dmt_trans_q = $con->query("select * from dmt_transactions where USER_ID='$id' and USER_TYPE='$usertype_id'  order by ID Desc");
