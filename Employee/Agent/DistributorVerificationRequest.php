  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Distributor Verification Request</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Distributor Verification Request</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th>Bank Account</th>
                    <th>E-Stamp</th>
                    <th>Transfer Request (For Approval) </th>
                  ...
                  <tr>
                    ...
                    <td><span class="badge badge-info right" data-toggle="modal" data-target="#exampleModalCenter">Transafer Modal</span></td>
                    <td>Active</td>
                    <td>Active</td>
                    <td>Active</td>
                  </tr>
