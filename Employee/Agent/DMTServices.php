    ...
    <!-- Main content -->
      ...
      <div class="container-fluid">
        ...
        ?>
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Domestic Money Transfer Data Table</h3>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                      $bene = $con->query("select * from cashfree_beneficiary where REMIT_MOBILE='".filterVal($_GET['Mobile'])."' order by ID Desc");
                                                    ...
                                                    <div class="card-block table-border-style">
                                                        <div class="table-responsive">
                                                            <table class="table table-striped">
                                                              ...
                                                              <tbody> 
                                                              <?php
                                                                  $dmt_trans_q = $con->query("select * from dmt_transactions where USER_ID='$usid' order by ID Desc");
          ...
          <div class="modal-body">
            <div class="form-row d-flex justify-content-around">
                ...
                <div class="form-group form-primary col-md-6">
                    ...
                    <input type="hidden" value="info@paydeer.in" required name="beneEmail" class="form-control">
