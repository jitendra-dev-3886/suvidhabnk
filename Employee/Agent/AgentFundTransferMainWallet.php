              ...
              <form method = "post" id="addempform" name="contact-form">
                ...
                <div class="form-row d-flex justify-content-around">
                    <div class="form-group col-md-5">
                        ...
                        <input type="number" class="form-control" name="WORKINGCRITERIA" id="WORKINGCRITERIA" placeholder="">
                    </div>
                    <div class="form-group col-md-5">
                ...
                <div class="card-footer d-flex justify-content-center">
                  <button type="submit" class="btn btn-primary" id="save" onclick="fun()">Fund Transfer</button>
                </div>
...
$(document).ready(function () {
    // var amt,$total_cpn;
    $(function(){
    $("#WORKINGCRITERIA").keyup(function (e){
      
      if($("#WORKINGCRITERIA").val() < 0) {
