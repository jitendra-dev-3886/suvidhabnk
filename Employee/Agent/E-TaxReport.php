...
<head>
  ...
  <title><?php echo $etxtype ?> E-TaxReport</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">E-TaxReport</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"><?php echo $etxtype ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo $etxtype ?> Data Table</h3>
              </div>
              <!-- /.card-header -->
              <div class="row">
...
<span id="datesbtn" class="searchicon" onclick="etaxform()"><i class="fas fa-search"></i></span>
 </div>
...
<script>
    ...
    var tod = $("#todate").val();
    $.ajax({
    url:"Backend/Etax/Etax_report.php?type=<?php echo $etxtype ?>",
    type:"POST",
    data:{formdate:fromd,todate:tod},
