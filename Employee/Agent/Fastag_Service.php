...
include("Backend/fastag/function.php"); // for operator
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Fastag </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Fastag </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                              ...
                              <div class="form-group form-primary col-md-3 ">
                                ...
                                <select name="recharge_operator" id="operator" onchange="getOperatorInfo(this.value)" required class="form-control fill">
                                    ...
                                    <?php
                                      ...
                                      foreach($op_data as $op_details){
                                          ?>
                                            <option value="<?php echo $op_details['id'] ?>"><?php echo $op_details['name'] ?></option>
                                          <?php
                                         }
                                      }
                ...
                <table id="example1" class="table table-bordered table-striped">
                   <thead>
                      ...
                      <tbody id="">
                            <?php
                        $i = 1;
                        $res = $con->query("SELECT * FROM fastag_transaction where USER_ID='$usid' ORDER BY ID DESC LIMIT 10");
                        if($res->num_rows > 0){
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="offerModalLongTitle">Fastag Now</h5>
      ...
      <div class="modal-body">
              <table class="table table-striped">
                 ...
                 <div class="form-group form-primary col-md-6 " id="">
                    <label class="float-label">Enter Amount</label>
                    <input type="number" required name="amount" id="amount" class="form-control" autocomplete="false">
                </div>
...
<script src="js/Fastag.js"></script>
