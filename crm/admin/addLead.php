                        ...
                        <form id="formData" >
                                 ...
                                 <div class="row">
                                  <div class="col-sm-6">
                                      ...
                                      <label for="exampleInputEmail1">Lead Manager</label>
                                          <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                         
                                              
                                            </div>
                                            <select class="custom-select" name="type_user" style="width: 200px;"  id="type_user">
                                                
                                                 <option selected value="0">Select Lead Manager</option>
                                            <?php  
