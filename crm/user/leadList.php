                              ...
                              <div class="col-12">
                                ...
                                <div class="card">
                                  ...
                                  <div class="card-block">
                                    <h4 class="sub-title"><?php echo $status ?> Lead List</h4>
                                    <div class="row">
 ...
 function load_data()
    {
      ...
      $.ajax({
        url:"Backend/leadDisplay.php",
        method:"POST",
        data:{pageid:2,tkn:Token,status:"<?php echo $status?>"},
        beforeSend: function(xhr){xhr.setRequestHeader('Token', localStorage.getItem('Token'));},
        success:function(data)
        {
          $('#leadData').html(data);
    ...
    $(document).on("click","#leadtbtn", function(){
      ...
      $.ajax({
        url: "../admin/Backend/leadDisplay.php",
        type: "POST",
