  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Commission Wallet Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Commission Wallet Report</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> Commission Wallet Report</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo ($debitrep['SUM(AMOUNT)'] == "") ? 0:$debitrep['SUM(AMOUNT)'];   ?></td>
                        <td><?php echo ($creditrep['SUM(AMOUNT)'] == "") ? 0:$creditrep['SUM(AMOUNT)'];   ?></td>
                        <td><?php echo $user['AEPS_BAL'] ?></td>
                        <td><a class="btn btn-primary" href="WalletReport?type=AEPS" target="_blank">View Details </a></td>
                    </tr>
                  </tbody> 
                </table>
              </div>
...
<script>
  ...
  $(document).ready(function () {
      ...
      {
          $.ajax({
              url: "handler/FundTransferAepsReport.php",
              type: "POST",
              data : {id:1},
