              ...
              <form>
                ...
                <div class="form-row d-flex justify-content-around">
                    <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Distributor ID : Status</label>
                         <select class="form-control select2" value="DistributorIDSTATUS" name="DistributorIDSTATUS" style="width: 100%;">
                ...
                <div class="form-row d-flex justify-content-around">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" value="DistributorNAME" name="DistributorNAME" class="form-control" placeholder="">
                      </div>
