  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Virtual Account Services Commission Setup</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Virtual Account  Services Commission Setup</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
                ...
                <h3 class="card-title">Virtual Account  Commission Setup</h3>
              </div>
              <!-- /.card-header -->
              <form method = "post" id="vaform">
               ...
               <div class="form-row d-flex justify-content-around ">
                ...
                <div class="card-footer d-flex justify-content-center">
                   <input type="hidden" value="1" name="vaformt">
                  <button type="button" id="save"  class="btn btn-primary">Set Commission Setup</button>
                </div>
                </form>
                </div>
                  <!-- /.card-body -->
...
<div id="deleteEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form>
				<div class="modal-header">						
					<h4 class="modal-title">Delete Virtual Account  Commission Setup</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				</div>
				<div class="modal-body">
					<input type="hidden" id="id_d" name="id" class="form-control">					
					<p>Are you sure you want to delete Virtual Account  Commission?</p>
				</div>
				<div class="modal-footer">
...
<script>
  $(document).ready(function(){
           ...
           function loadData()
             {
                $.ajax({
                url: "handler/VirtualAccountCharge.php",
                type: "POST",
                data : {id:1},
                success: function(data){
                    $("#VirtualAccount_disp").html(data);
                }
            });
          }
           ...
           function companyData()
             {
                ...
                data : {id:2},
                success: function(data){
                    $("#VirtualAccount_disp2").html(data);
                }
            });
          }
        companyData();
