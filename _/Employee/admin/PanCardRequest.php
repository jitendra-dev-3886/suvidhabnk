  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">PanCardRequest</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">PanCardRequest</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
$(document).on('click','#update',function(e) {
    ...
    $.ajax({
      ...
      success:function(data)
          ...
          let rs_code = rspns.response_code;
          ...
          if(rs_code == "1"){
            Swal.fire({
                      ...
                      location.replace("PanCardRequest.php");
            });
          } 
          else{
              Swal.fire({
