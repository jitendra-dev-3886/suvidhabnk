        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Redirect Link</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Redirect Link</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                   ...
                   <div class="form-row d-flex justify-content-around">
                       ...
                       <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">Source URL</label>
                          <input type="text" id="source" name="source" class="form-control" placeholder="Souce URL">
                      </div>
                     
                     <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Match</label>
                                <select class="form-control select2" id="match" name="match" style="width: 100%;">
                     ...
                     <div class="form-row d-flex justify-content-around">
                       <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">When Matched</label>
                             <select class="form-control select2" id="when_matched" name="when_matched" style="width: 100%;">
                                    <option value="URL and Login Status">Redirect to URL</option>
                             </select>
                       </div>
                       <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">with HTTP code</label>
                            <select class="form-control select2" id="http" name="http" style="width: 100%;">
                  ...
                  <div class="form-row d-flex justify-content-around">   
                     <div class="form-group col-md-6">
                            ...
                            <input type="text" id="log_in" name="log_in" class="form-control" placeholder="">
                     </div>
                     <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Logged out</label>
                            <input type="text" id="log_out" name="log_out" class="form-control" placeholder="">
                       </div>
                  </div>  
                ...
                <div class="card-footer d-flex justify-content-center">
                  <button type="submit" id="redirect_url" name="redirect_url" class="btn btn-primary">Redirect URL</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Redirected Link list</h3>
              </div>
              <!-- /.card-header -->
