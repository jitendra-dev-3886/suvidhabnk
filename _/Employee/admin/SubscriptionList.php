...
.reload {
  animation: rotate-btn .5s linear 0.2s infinite;
  -webkit-animation: rotate-btn .5s linear 0.2s infinite;
  transition:all 0.3s;
}
...
<span id="datesbtn" class="searchicon" onclick="load_data()"><i class="fas fa-search"></i></span>
 ...
 <div class="px-4 col-md-2">
        <button type="button" id="subsrefbtn" class="searchicon">Refresh <i id="reloadicon" class="fas fa-redo-alt"></i></button>
    </div>
</div>
<div class="row">
    
</div>
              <div class="card-body" id="subsdata">
...
<script>
 ...
 load_data();
    ...
    $(document).ready(function(){
        $("#subsrefbtn").click(function(){
            $("#reloadicon").addClass("reload");
            
            $.ajax({
                url : "Backend/Subscription/cashfree/subscription_callback.php",
                type : "POST",
                data :{pageid:1},
                success : function(response){
                    $("#reloadicon").removeClass("reload");
