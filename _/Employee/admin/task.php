              ...
              <form method = "post" id="addNews" name="addNews">
                ...
                <div class="form-row d-flex justify-content-around ">
                    <div class="form-group col-md-5" id="user_type">
                        ...
                        <input type="text" class="form-control" name="name" id="name" placeholder="Enter Mobile Number">
                ...
                <div class="form-row d-flex justify-content-around">
                    <div class="form-group col-md-5" id="news">
                        ...
                        <textarea type="text" name="desc" class="form-control" id="desc" rows="5" cols="25" placeholder="Enter Task"></textarea>
                      </div>
                  </div>
                  <div class="form-row d-flex justify-content-around">   
                ...
                <div class="card-footer d-flex justify-content-center">
                  <button type="submit" class="btn btn-primary" id="add_news">Add Task</button>
                </div>
