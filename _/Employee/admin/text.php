              ...
              <!-- form start -->
                ...
                <div class="form-row d-flex justify-content-around">
                    <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Distributor ID</label>
                         <select class="form-control select2" value="DistributorID" name="DistributorID" id="DistributorID" style="width: 100%;">
                    </div>
                    
                     <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Distributor ID : Type</label>
                         <select class="form-control select2" value="DistributorNAME" name="DistributorNAME" style="width: 100%;">
                   ...
                   <div class="form-row d-flex justify-content-around">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="file" value="image" name="profilepic"id="profilepic"class="form-control" placeholder="">
                      </div>
                      <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Distributor Name</label>
                        <input type="text" id="DistributorNAME" name="DistributorNAME" class="form-control" placeholder="">
                      </div>
                      </div>
                ...
                <div class="form-row d-flex justify-content-around">
                    ...
                    <div class="form-group col-md-4">
                     ...
                     <div class="form-group col-md-4">
                        ...
                        <input type="text" id="Distributo" name="DistributorNAME" class="form-control" placeholder="">
                      </div>
