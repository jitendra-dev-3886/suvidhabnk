  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">XDMT Charge Setup</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">XDMTCharge Setup</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
                ...
                <h3 class="card-title">XDMT Charge Setup</h3>
              </div>
              <!-- /.card-header -->
                <?php 
                  $packid = $_GET['pack_id'];
                ...
                <div class="card-footer d-flex justify-content-center">
                  <button type="submit" id="xdmtCom" class="btn btn-primary">Set Commission Setup</button>
                </div>
                </form>
                  <div id="response"></div>  
...
<!-- Page specific script -->
 ...
 $(document).ready(function(){  
       //  display...
          ...
          function loadData()
             {
              var packid = $("#packid").val();
                $.ajax({
                url: "handler/XDMTChargeSetup.php",
                type: "POST",
        ...
        $('#xdmtCom').click(function(e){ 
             e.preventDefault();
         if($('#XDmt_Form')[0].checkValidity()){
