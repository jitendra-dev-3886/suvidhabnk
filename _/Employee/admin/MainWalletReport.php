          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <tbody>
                    <?php
                    $debitrep = $con->query("select SUM(AMOUNT) from report where FUND_TYPE='debit' and WALLET='MAIN'  AND TRANS_DATE='".date("Y-m-d")."'")->fetch_assoc();
                    $creditrep = $con->query("select SUM(AMOUNT) from report where FUND_TYPE='credit' and WALLET='MAIN' AND TRANS_DATE='".date("Y-m-d")."' ")->fetch_assoc();
                 ...
                 $total_main = $con->query("SELECT  FORMAT(IFNULL(SUM(MAIN_BAL),0),2)main FROM `user`")->fetch_assoc();
                    ...
                    <tr>
                        ...
                        <td><?php echo $total_main['main'] ?></td>
                        <td><a class="btn btn-primary" href="AdminWalletReport?type=MAIN" target="_blank">View Details </a></td>
                    </tr>
                  </tbody> 
                </table>
              </div>
