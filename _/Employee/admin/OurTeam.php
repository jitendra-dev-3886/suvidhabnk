            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                ...
                <div class="card-footer d-flex justify-content-center">
                  <button type="submit" id="add_team" name="add_team" class="btn btn-primary">Add Team</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
...
$.ajax({
     ...
     if(data==1){
          Swal.fire({
              icon: 'success',
              title: 'Delete Team Member successful..',
              button: 'Okay'
             }).then(function(){
                      location.replace('OurTeam.php');
             });
             ...
             Swal.fire({
              icon: 'error',
              title: 'Delete Team Member Unsuccessful..',
              button: 'Okay'
             }).then(function(){
                      location.replace('OurTeam.php');
             });
