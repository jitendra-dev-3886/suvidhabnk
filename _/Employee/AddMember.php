        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" id="addmem" enctype="multipart/form-data" autocomplete = "off">
                <div class="card-body">
                ...
                <div class="form-group col-md-3">
                    <label for="exampleInputEmail1">Upload Adhaar</label>
                ...
                <div class="form-group col-md-3">
                  ...
                  <input type="password" class="form-control pass" name="mempass" placeholder="" autocomplete = "off" required>
                </div>
                
                <div class="form-group col-md-3">
                    <label for="exampleInputEmail1">Confirm Password :</label>
                  <input type="password" class="form-control cpass" name="memcpass" placeholder="" required>
                </div>
