...
<head>
  ...
  <title> Vehicle Insurance | PayDeer </title>
                                ...
                                <div class="tab-pane" role="tabpanel" id="step3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control"  name="salaryslip" id="salaryslip" required> 
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Bank Statement *</label> 
                                            <input type="file" class="form-control"  name="bankstmt" id="bankstmt" required> 
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Last Year ITR *</label> 
                                            <input type="file" class="form-control"  name="last_itr" id="last_itr" required> 
                                        </div>
                                    </div>
