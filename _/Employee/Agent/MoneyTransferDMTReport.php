...
include("Backend/AEPS/Paysprint/aeps_function.php"); // aeps use
 ...
 if(isset($_GET['MyLatestReport'])){
        $rep =  $con->query("SELECT * FROM `dmt_transactions` where USER_ID='$usid' order by ID Desc LIMIT 1")->fetch_assoc();
        $repId = $rep['REFFRENCE_ID'];
        header("location: Recipt/DMTRecipt?refrence_id=$repId");
    }
...
<head>
  ...
  <title>Money Transfer DMTReport</title>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DMT Report Data Table</h3>
              </div>
