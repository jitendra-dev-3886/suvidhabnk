 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="container-fluid">
           <?php
                $user_exist = check_aeps_user($id, $usertype_id);
                // echo $user_exist;
                // echo getbank();
                if ($user_exist == 0) {
                    //  echo "<script>location.replace('api/paysprint/aeps/aeps_onboard.php')</script>";
                ?>
                    <h3 class='mx-auto text-center mt-5 text-capitalize'>Your are not register for payout yet. Please register</h3>
                    <div class="card-block my-3">
                        <form class="form-material" method="post">
                            <div class="col-md-4  text-center mx-auto" id="send_otp_area">
                                <a type="button" target="_blank" href="Backend/AEPS/Paysprint/aeps_onboard.php" class="btn btn-primary"><i class="far fa-paper-plane"></i>Register Now</a>
                            </div>
                        </form>
                    </div>
                <?
                                 ...
                                 <div class="main-body">
                                    <div class="page-wrapper">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                            ...
                                                            <div class="card-block m-3">
                                                                 <form class="form-material" id="payout">
                                                                        ...
                                                                        <div class="form-row mt-4 d-flex justify-content-center">
                                                                             <div class="col-md-4">
                                                                                <button type="submit" class="btn waves-effect waves-light btn-primary btn-block btn-outline-primary text-light"><i class="far fa-paper-plane"></i>Submit</button>
                                                                            </div>
                                                    ...
                                                    <!--New table Start-->
                                                                <div class="card">
                                                                  <div class="card-header">
                                                                    <h3 class="card-title">Payout Report Data Table</h3>
                                                                  </div>
                                                                   <div class="row">
                                        ...
                                        <?php 
                                            ...
                                            //  echo "<a href='Payout_new.php' class='btn btn-primary' >Choose another account </a>";
                                            ...
                                            <div class="page-body">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="card">
                                                                <div class="card-header">
                                                            <h5>Do Transaction. ( Account : <?php echo $ben['account'] ?> ) ( IFSC : <?php echo $ben['ifsc'] ?> )  <a href='Payout_new.php' class='btn btn-primary' >Choose another account </a> </h5>
                                                                    ...
                                                                    <div class="card-block my-3">
                                                                         <form class="form-material" id="payout_verify" enctype="form-data/multipart">
                                                                               ...
                                                                               <input type="hidden" name="accID" id="accID" value="<?php echo $selectedId  ?>">
                                                                                ...
                                                                                <div class="form-row mt-4 d-flex justify-content-center">
                                                                                     <div class="col-md-4">
                                                                                        <button type="submit" class="btn waves-effect waves-light btn-primary btn-block btn-outline-primary"><i class="far fa-paper-plane"></i>Submit</button>
                                                                                    </div>
                                        ...
                                        <div class="page-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h5>Do Transaction. ( Account : <?php echo $ben['account'] ?> ) ( IFSC : <?php echo $ben['ifsc'] ?> )   <a href='Payout_new.php' class='btn btn-primary float-right'>Choose another account </a>  </h5>
                                                        </div>
                                                            <div class="card-block my-3">
                                              ...
                                              <div class="page-body">
                                                <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="card">
                                                                <div class="card-header">
                                                                    <h5>Choose Account. <a href='Payout_new?addNewAcc' class='btn btn-primary float-right' >Create New Account</a></h5>
                                                                </div>
                                                                    <div class="card-block my-3">
                                                                        <?php
                                                                        // $payoutUser = $con->query("select * from payout_users where US_ID='$usid'");
                                                                        ...
                                                                        // if(count($pytDt) <= 5){
                                                                        //   hidden by sk // echo "<a href='Payout_new?addNewAcc' class='btn btn-primary' >Create New Account</a>";
                                                                        // }
                                                                        // else{
                                                                        ...
                                                                        ?>
                                                                         ...
                                                                         <form class="form-material" method="get">
                                                                                <div class="form-row d-flex justify-content-around">
                                                                                   <div class="form-group form-primary col-md-8">
                                                                                            <select name="selectAcc" required class="form-control fill">
                                                                                                <option value="">Select Account</option>
                                                                                                <?php  
                                                                                                $accs = $con->query("select * from payout_users where US_ID='$usid'");
