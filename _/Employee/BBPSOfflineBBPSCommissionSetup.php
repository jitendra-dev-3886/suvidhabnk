                      ...
                      <div class="form-group col-md-3">
                       ...
                       <select name="ser_name" id="ser_name" required="" class="form-control fill">
                                    <option value="">Select Category</option>
                                          <option value="OFFLINE_EMI">EMI</option>
                                          <option value="OFFLINE_GAS">Gas</option>
                                          <option value="OFFLINE_BROADBAND">Broadband</option>
                                          <option value="OFFLINE_ELECTRICITY">Electricity</option>
                                          <option value="OFFLINE_INSURANCE">Insurance</option>
                                          <option value="OFFLINE_WATER">Water</option>
                                          <option value="OFFLINE_POSTPAID">Postpaid</option>
                                          <option value="OFFLINE_LANDLINE">Landline</option>
                                          <option value="OFFLINE_TRAFFICCHALLAN">Traffic Challan</option>
                                          <option value="OFFLINE_CABLE">Cable</option>
                                          <option value="OFFLINE_HOSPITAL">Hospital</option>
                                          <option value="OFFLINE_LPG">LPG</option>
                                          <option value="OFFLINE_MUNICIPALITY">Municipality</option>
                                          <option value="OFFLINE_DIGITALVOUCHER">Digital Voucher</option>
                                          <option value="OFFLINE_DATACARDPREPAID">Datacard Prepaid</option>
                              </select>
                      </div>
       ...
       $(document).ready(function(){
        //   display
           function loadData()
             {
                $.ajax({
                url: "handler/BBPS_Offline_Commission.php",
                type: "POST",
                data : {id:1},
