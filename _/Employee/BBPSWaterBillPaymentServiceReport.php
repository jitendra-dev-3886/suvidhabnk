  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Water BBPS Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Water BBPS Report</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Water BBPS Report Data Table</h3>
              </div>
              <!-- /.card-header -->
...
<script>
    ...
    var tod = $("#todate").val();
        ...
        $.ajax({
            url : "handler/BBPS_Report.php",
            type : "POST",
            data : {formdate:fromd,todate:tod,category:"Water",pageid:4},
