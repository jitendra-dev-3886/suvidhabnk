        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Fastag Commission Setup</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <form method="post" id="Fastagsetup">
                <div class="card-body">
               <div class="form-row d-flex justify-content-around ">
                ...
                <div class="card-footer d-flex justify-content-center">
                   <input type="hidden" value="1" name="Fastag_type">
                  <button type="submit" id="Fastag_save" class="btn btn-primary">Set Commission Setup</button>
                </div>
                </form>
                </div>
                  <!-- /.card-body -->
           ...
           function companyData()
             {
                ...
                data : {id:2},
                success: function(data){
                    $("#Fastag_disp2").html(data);
                }
            });
          }
        companyData();

          $("#Fastag_save").click(function(e){
              e.preventDefault();
            //   console.log("hELLO");
                  $.ajax({
                   url: "handler/fastag_commSetup.php",
