  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">AePs Services AdharPay Commission Setup</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">AePs Services AdharPay Commission Setup</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <form id="aadharsetup">
               ...
               <div class="form-row d-flex justify-content-around ">
                ...
                <div class="card-footer d-flex justify-content-center">
                  <input type="hidden" value="1" name="aadhar_type">
                  <button type="submit" id="aadhar_save" class="btn btn-primary">Set Commission Setup</button>
                </div>
       ...
       $(document).ready(function(){
        //   display
           function loadData()
             {
                $.ajax({
                url: "handler/AdharPayCommissionSetup.php",
                type: "POST",
                data : {id:1},
                success: function(data){
                    $("#aadhar_disp").html(data);
                }
            });
          }
        loadData();
           function companyData()
             {
                ...
                data : {id:2},
                success: function(data){
                    $("#aadhar_disp2").html(data);
                }
            });
          }
        companyData();

          $("#aadhar_save").click(function(e){
              e.preventDefault();
            //   console.log("hELLO");
                  $.ajax({
                  url: "handler/AdharPayCommissionSetup.php",
                  type : "POST",
                  data : $("#aadharsetup").serialize(),
                  success : function(data){
                         alert('AePsServicesAdharPayCommissionSetup added successfully !'); 
                         $("#aadharsetup")[0].reset();
                    // location.reload();
                       loadData();
                       companyData();
