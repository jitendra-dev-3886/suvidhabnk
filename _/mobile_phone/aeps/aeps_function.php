...
$time = date("Y-m-d g:i:s A");
        ...
        insert_allreport($user_id  ,$ref_id , "AEPS Commission" ,$crnt_bal , $update_bal , $givenCom , $pack['AMOUNT_TYPE'] , "AEPS Transaction Commission", $ip_address, $device);
        insert_allreport($ds_id  ,$ref_id , "AEPS Commission" ,$ds_main_bal , $ds_update_bal , $ds_givenCom , $pack['AMOUNT_TYPE'] , "AEPS Transaction Commission", $ip_address, $device);
        insert_allreport($ms_id  ,$ref_id , "AEPS Commission" ,$ms_main_bal , $ms_update_bal , $ms_givenCom , $pack['AMOUNT_TYPE'] , "AEPS Transaction Commission", $ip_address, $device);
