  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Distributor <?php echo $_GET['type'] ?> Wallet Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Distributer <?php echo $_GET['type'] ?> Wallet Report</h3>
              </div>
               <div class="row">
...
<script>
    ...
    var tod = $("#todate").val();
      $.ajax({
        url:"ajaxphp/fundtransactionreport.php",
        method:"POST",
        data:{pageid:2, type:'<?php echo $_GET['type'] ?>' ,id:'<?php echo $_GET['id'] ?>',formdate:fromd,todate:tod},
...
//             type : "POST",
//             data : {formdate:fromd,todate:tod,pageid:5 , type:'<?php echo $_GET['type'] ?>',id:'<?php echo $_GET['id'] ?>'},
