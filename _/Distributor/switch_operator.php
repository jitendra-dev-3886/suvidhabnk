                                                        ...
                                                        <form class="form-material" action="handler/switch_operator.php" method="post" enctype="multipart/form-data">
                                                            <div class="form-row d-flex justify-content-around">
                                                                ...
                                                                <div class="form-group form-primary col-md-2">
                                                                    <input required type="number" name="long_code" class="form-control">
                                                                    <span class="form-bar"></span>
                                                            ...
                                                            <div class="form-row mt-4 d-flex justify-content-center">
                                                                <div class="col-md-8">
                                                                    <button type="submit" name="add_switch" class="btn waves-effect waves-light btn-primary btn-block btn-outline-primary"><i class="ti-panel"></i>Add Switch Switch Operators</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                              ...
                                                              <div class="card-body">
                                                                 ...
                                                                 <thead>
                                                                   ...
                                                                   <?php
                                                                    $user_id = $_SESSION['id']; 
                                                                    $i = 1;
                                                                        $res = $con->query("SELECT * FROM switchOperator order by ID desc");
                                                                    ...
                                                                    <tr class="">
                                                                        ...
                                                                        <td><?php echo $paysprint['APICOMPANY'] ?></td>
                                                    ...
                                                    <div class="card-block my-3">
                                                        <form class="form-material" action="handler/switch_operator.php" method="post" enctype="multipart/form-data">
                                                            <div class="form-row d-flex justify-content-around">
                                                                ...
                                                                <div class="form-group form-primary col-md-2">
                                                                    <input required type="number" name="long_code" class="form-control"  value="<?php echo $paysprint_api['LONGCODE'] ?>">
                                                                    <span class="form-bar"></span>
                                                                    <label class="float-label">Long Code</label>
                                                                </div>
                                                                <div class="form-group form-primary col-md-2">
                                                            ...
                                                            <div class="form-row mt-4 d-flex justify-content-center">
                                                                <div class="col-md-8">
                                                                    <button type="submit" name="update_switch" class="btn waves-effect waves-light btn-primary btn-block btn-outline-primary"><i class="ti-panel"></i>Update Switch Operators</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
