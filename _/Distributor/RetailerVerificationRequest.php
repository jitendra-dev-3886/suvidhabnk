  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Retailer Verification Request</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Retailer Verification Request</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th>Bank Account</th>
                    <th>Subscription</th>
                    <th>Approved/ Reject / Profile Update</th>
                    <th>Approved/ Reject By</th>
                    <th>Approved/ Reject Time and Date </th>
                  </tr>
                  </thead>
                  <tbody>
                  <tr>
                    ...
                    <td><span class="badge badge-info right" data-toggle="modal" data-target=".bd-example-modal-lg">View Profile</span></td>
                    <td>Active</td>
                    <td>Active</td>
                    <td>Active</td>
                    <td>Active</td>
      ...
      <div class="modal-body">
         ...
         <div class="row">
             <div class="col-12">
               <div class="form-row d-flex justify-content-between ">
                <div class="form-group col-md-3">
                  <label for="inputCity">Download Aadhar</label>
                </div>
                <div class="form-group col-md-3">
                  <label for="inputCity">Download E-Stamp</label>
                </div>
                <div class="form-group col-md-3">
                  <label for="inputCity">Download PAN</label>
                </div>
                <div class="form-group col-md-3">
                  <label for="inputCity">View Video KYC</label>
                </div>
                </div>
              </div>
          </div>     
