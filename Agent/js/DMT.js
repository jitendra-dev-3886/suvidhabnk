                                   ...
                                   let rspns = rslt.response;
                                    switch(rspns[i].txn_status){
                                      ...
                                      if(rspns[i].response_code == 1){
                                         ...
                                         recieptloc += location.replace(`Recipt/DMTRecipt?refrence_id=${rspns[i].referenceid}`);
                                      }
                            ...
                            .then((result) => {
                              ...
                              let rspns = rslt.response;
                                switch(rspns.txn_status){
                                  ...
                                  if(rspns.response_code == 1 && rspns.txn_status != 0 && rspns.txn_status != 5){
                                      msg = "Status: "+st+" Msg :"+rspns.message+" Amount: "+rspns.txn_amount;
                                     swal.fire({
                                          title: st,
                                          text:  msg,
                                          icon: 'success',
                                          ...
                                          closeOnClickOutside: false, 
                                              ...
                                              location.replace(`Recipt/DMTRecipt?refrence_id=${referenceid}`);
                                           }
                                        );
                                  }
                                     ...
                                     popup('error' , 'OOPS..!' ,"Server Error");
                                      ...
                                      msg = "Status: "+st+" Msg :"+rspns.message+" Remarks :"+rspns.remarks;
                                      popup('error' , st  ,msg);
                                  }
                      }
                      }
