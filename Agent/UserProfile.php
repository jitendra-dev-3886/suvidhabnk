          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <!--    </div>-->
                <!--  </div>-->
                  <a href="IdentityCard.php" class="btn btn-primary" target="_blank">Identity Card</a></button>
                  <a href="certificate.php" class="btn btn-primary" target="_blank">Certificate</a></button>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
