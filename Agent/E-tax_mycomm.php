                 ...
                 <form id="setE-TaxPan" name="setE-TaxPan">
                  <div class="form-row d-flex justify-content-around ">
                     <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="coupon_price" name="coupon_price" value="<?php echo $res['CHARGE'] ?>" readonly>
                      </div>
                     <div class="form-group col-md-2">
                        <label for="exampleInputEmail1">RT Commission</label>
                        <input type="text" class="form-control" id="rt_comm" name="rt_comm" value="<?php echo $res['RT_COMM'] ?>" readonly>
                      </div>
                      <div class="form-group col-md-2">
                        <label for="exampleInputEmail1">DT Commission</label>
                        <input type="text" class="form-control" id="dt_comm" name="dt_comm" value="<?php echo $res['DT_COMM'] ?>" readonly>
                      </div>
                     <div class="form-group col-md-2">
                        <label for="exampleInputEmail1">GST</label>
                        <input type="number" class="form-control" id="tds" name="tds" value="<?php echo $res['TDS'] ?>" readonly>
                      </div>
                     <div class="form-group col-md-2">
                        <label for="exampleInputEmail1">TDS</label>
                        <input type="number" class="form-control" id="gst" name="gst" value="<?php echo $res['GST'] ?>" readonly>
                      </div>
                </div>
