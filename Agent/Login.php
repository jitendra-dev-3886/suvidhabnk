	...
	<div class="container">
		...
		<div id="main_area">
			<form id="login_form" class="php-email-form" method="post" autocomplete="off">
				...
				<h3 class="title">Welcome To Suvidhabnk</h2>
           		<div class="input-div one">
           		   ...
           		   <div class="div">
           		   		<h5>Mobile</h5>
           		   		<input type="number" name="mobile" onkeypress="return this.value.length < 10;" id="mobile"class="input fill" autocomplete="off">
           		   </div>
           		</div>
            	...
            	<a href="forget_password.php">Forgot Password?</a>
                  ...
                  <!--otp form-->
                  <div class="card-block" id="otp_area">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <p id="demo" class="text-center"></p>
                                            <h3 class="text-center" id="otp_msg"></h3>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            <h5 style="margin-right: 59%;">Enter OTP</h5>
                                        <input type="text" name="otp" id="otp" class="form-control" style="padding: 7px;">
                                    </div>
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" name="otp_submit" id="otp_submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Submit OTP</button>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-10">
