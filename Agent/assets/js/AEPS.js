                     ...
                     let rslt = JSON.parse(data);
                      ...
                      let msg = rslt.message; 
                        ...
                        if($("#transType :selected").val() == "MS"){
                              let msm = rslt.ministatement;
                               for(i=0;i<Object.keys(msm).length; i++){
                                      msg += "<br> Date : "+msm[i].date+" TxnType : "+msm[i].txnType+" Amount : "+msm[i].amount+" Narration : "+msm[i].narration+" <br>";
                                }
                            new swal({
                              title: 'Congratulations',
                              html:  "<pre> Transaction Successfull. Statement : <br>" + msg + "</pre>",
                              icon: 'success',
                          ...
                          customClass: {
                            ...
                            .then((result) => {
                              if (result.isConfirmed) {
                                location.replace("AEPS_Report?MyLatestReport");
                              } else{
                                location.replace("AEPS");
                              }
                            });
                          } else if($("#transType :selected").val() == "BE"){
                              console.log(rslt);
                        ...
                        //   else  if($("#transType :selected").val() == "BE"){
                        //       msg += "<br> Balance : "+rslt.balanceamount;
                        //       $("#be_bal").text(rslt.balanceamount);
                        //       $("#be_msg").text(rslt.message);
                        //       $("#be_aadhar").text($("#aadhar").val());
