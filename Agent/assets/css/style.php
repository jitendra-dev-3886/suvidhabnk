...
$web_setting = $con->query("SELECT * FROM `websetting` WHERE ID = 1");
$web = $web_setting->fetch_assoc();
$theme_color = $web['COLOR'];
...
.header-navbar .navbar-wrapper .navbar-container .header-notification .profile-notification li {
	border-top: 1px solid <?=$theme_color?>, #ffe100, #d6d6d6, #ff5252, #11c15b, #37474f, #00bcd4;
	line-height: initial;
	padding: 1em 20px;
	width: 100%;
	-webkit-transition: all 0.3s ease-in-out;
...
.popover-body .display-color {
	...
	margin-right: 30px;
	background-color: rgb(244 67 54 / 28%);
	border-color: rgb(244 67 54 / 28%);
}
...
.radio .helper::before {
	...
	border-radius: 50%;
	border: 0.125rem solid <?=$theme_color?>;
}
...
.radio.radio-outline .helper::after {
	background-color: #fff;
	border: 0.225rem solid <?=$theme_color?>;
}
...
.proj-progress-card .progress .progress-bar.bg-c-blue:after {
	border: 3px solid <?=$theme_color?>;
	-webkit-box-shadow: 0 0 0 5px rgb(244 67 54 / 28%), 0 10px 7px 0 rgba(62, 57, 107, 0.18);
	box-shadow: 0 0 0 5px rgb(244 67 54 / 28%), 0 10px 7px 0 rgba(62, 57, 107, 0.18);
}
