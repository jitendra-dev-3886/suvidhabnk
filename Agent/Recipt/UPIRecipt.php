...
$recipt = $con->query("SELECT * FROM upi_transactions WHERE REFFRENCE_ID = '$refrence'")->fetch_assoc();
...
<div class="receipt">
    <div class="receipt__holder">
        <div class="receipt__headline">
            <h4 class="headline__title receipt__title">UPI Receipt </h4>
        </div>
        <div class="receipt__paper">
            <div id="reciptid" class="receipt__info">
        <img src="Logo/upi.png" alt="AdminLTE Logo" class="rounded mx-auto d-block" width="90">
                ...
                <div class="receipt__block">
                    <label>Name:</label>
                    <p><?php echo $recipt['NAME'] ?></p>
                </div>
                <div class="receipt__block">
                    <label>UPI Id:</label>
                    <p><?php echo $recipt['UPI_ID'] ?></p>
                </div>
                <div class="receipt__block">
