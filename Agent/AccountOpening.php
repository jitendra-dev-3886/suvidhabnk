  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Account Open </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Account Open </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <!-- /.content-header -->
              <form method = "post" action="Backend/AccountOpen/main" autocomplete="off">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Account Open </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <!--<form action="Backend/AccountOpen/main">-->
                <div class="card-body">
                            <div class="form-row d-flex justify-content-around ">
                              <div class="form-group form-primary col-md-3 ">
                                <label class="float-label">Select Account Type</label>
                                <select name="acctype" id="acctype" required class="form-control fill">
