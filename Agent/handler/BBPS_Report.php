...
if($mode != ''){
  ...
  $sql = "
SELECT * FROM pay_bill_api WHERE USER_ID='$usid' $whr AND FILTER_DATE between '$fromdate' and '$todate' ORDER BY ID DESC
";
...
if(isset($_POST['pageid']) && $_POST['pageid'] == 2){
 ...
 $i = 1;
  ...
  $sql = "
SELECT * FROM pay_bill_api WHERE USER_ID='$usid' $whr AND FILTER_DATE BETWEEN '{$fromdate}' AND '{$todate}'
";
