...
function give_payout_com($ref_id , $user_id , $usertype){
    ...
    // echo "Payout com working \n";
        ...
        $existrow = $con->query("select * from commission_report where SERVICE='Payout' and REFFRENCE='$ref_id' and USER_ID='$user_id' ")->num_rows;
...
$time = date("Y-m-d g:i:s A");
        ...
        //Inser into commission report
         $con->query("INSERT INTO `commission_report`(`SERVICE`, `REFFRENCE`, `USER_ID`, `USER_TYPE`, `AMOUNT`, `COMMISSION`,`GST` ,`TDS`, `TIME`) 
                    VALUES ('Payout Charge','$ref_id','$user_id','46','".$trans['AMOUNT']."','$charge_amount','0' ,'0' ,'$time')");
...
$time = date("Y-m-d g:i:s A");
        ...
        //Inser into commission report
         $con->query("INSERT INTO `commission_report`(`SERVICE`, `REFFRENCE`, `USER_ID`, `USER_TYPE`, `AMOUNT`, `COMMISSION`,`GST` ,`TDS`, `TIME`) 
                    VALUES ('Payout Refund Charge','$ref_id','$user_id','46','".$trans['AMOUNT']."','$charge_amount','0' ,'0' ,'$time')");
    
         $con->query("INSERT INTO `commission_report`(`SERVICE`, `REFFRENCE`, `USER_ID`, `USER_TYPE`, `AMOUNT`, `COMMISSION`,`GST` ,`TDS`, `TIME`) 
                    VALUES ('Payout Refund','$ref_id','$user_id','46','".$trans['AMOUNT']."','$givenCom','$gst' ,'$tds' ,'$time')");
        ...
        $con->query("update user set AEPS_BAL='$ds_update_bal'  where ID='$ds_id' ");
        insert_allreport($ds_id  ,$ref_id , "Payout Refund Commission" ,$ds_aeps_bal , $ds_update_bal , $ds_givenCom , "Debit" , "Payout Refund Transaction Commission" , "AEPS");
        $con->query("update user set MAIN_BAL='$ms_update_bal'  where ID='$ms_id' ");
        insert_allreport($ms_id  ,$ref_id , "Payout Refund Commission" ,$ms_main_bal , $ms_update_bal , $ms_givenCom , "Debit" , "Payout Refund Transaction Commission" , "MAIN");
