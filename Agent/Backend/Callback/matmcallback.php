...
// checkStatus("SVDH9911611346", "SUVEgWL0U8cn61671188334834");
...
function hitrecon($requestBody){
        ...
        echo json_encode(['hitType'=>'recon', 'header'=>$header, 'request'=>$requestBody, 'response'=>$array ,'hash'=>$hashgen, 'concatstr'=>$requestBody.$simpleString]);
        // exit;
