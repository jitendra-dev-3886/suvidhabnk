...
include("Backend/AEPS/Paysprint/aeps_function.php"); // aeps use
 ...
 if(isset($_GET['MyLatestReport'])){
        ...
        header("location: Recipt/RechargeRecipt?refrence_id=$repId&service=Prepaid");
    }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Recharge Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Recharge Report Data Table</h3>
              </div>
               <div class="row">
...
<script>
    ...
    var tod = $("#todate").val();
      $.ajax({
        ...
        method:"POST",
        data:{pageid:4,type:"8",formdate:fromd,todate:tod},
