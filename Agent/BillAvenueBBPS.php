...
<head>
  ...
  <title> Bharat Bill Payment System | <?php echo $row['NAME'] ?> </title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">BBPS </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">BBPS </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Bharat BillPay</h3>
                <img src="img/bharat_bil.png" width="120" style="float:right">
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                <div class="card-body">
                     <div class="form-row d-flex justify-content-around ">
                                            ...
                                            <div class="form-group form-primary col-md-3 ">
                                                <label class="float-label">Select Paytype</label>
                                                <select name="paytype" id="paytype" onchange="getType(this.value)" required class="form-control fill">
                                                    <option value="">Select Paytype</option>
                                                    <option value="FetchPay">FetchPay</option>
                                            ...
                                            <div class="form-group form-primary col-md-3 ">
                                                ...
                                                <select name="recharge_operator" id="operator" onchange="getOperatorInfo(this.value)" required class="form-control fill">
                                                    ...
                                                    <!--<option value="HPCL00000NAT01">HPCL</option>-->
                                                    <!--<option value="OTME00005XXZ43">OTME</option>-->
                                                    <!--<option value="OTNS00005XXZ43">OTNS</option>-->
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group form-primary col-md-3 " id="quickpayAmount" style="display:none;">
                                                <label class="float-label" id="canum_label">Enter Amount</label>
                                                <input type="text" id="quickpayamount" name="quickpayamount" class="form-control" autocomplete="false">
                                                <span class="form-bar"></span>
                                            </div>
                ...
                <div class="card-footer d-flex justify-content-center">
                    <div class="col-md-4">
                        <button type="button" style="display:none;" id="fetchBtn" class="btn btn-primary">Fetch Bill</button>
                        <button type="button" style="display:none;" id="quickpayBtn" class="btn btn-primary">Pay Now </button>
                    </div>
                </div>
            </div>
            <!-- /.card -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                   <thead>
                      ...
                      <tbody id="">
                            <?php
                        $i = 1;
                        $res = $con->query("SELECT * FROM pay_bill_api where USER_ID='$usid' and MODE='online' ORDER BY ID DESC LIMIT 10");
                        if($res->num_rows > 0){
                            while($rc_rpt = $res->fetch_assoc()){
                                $num =  json_decode($rc_rpt['RESPONSE'],true);
                                $bill_num = $num["RespBillNumber"];
                                ?>
                             <tr>
                               <th scope="row"><?php echo $i++ ?></th>
                                ...
                                <td><a href="#" onclick="checkBBPSstatus('<?php echo $rc_rpt['REFFRENCE_ID'] ?>')">check status</a></td>
                           </tr>
                           <?php
                             }
                            }
...
<!--</form>-->
<!-- Offer  Modal -->
<div class="modal fade bd-example-modal-lg" id="offerModalCenter" tabindex="-1" role="dialog" aria-labelledby="offerModalCenterTitle" aria-hidden="true" >
  <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width:1000px !important; " role="document">
    <div class="modal-content">
      <div class="modal-header">
        <!--<h5 class="modal-title" id="offerModalLongTitle"><img src="https://suvidhabnk.com/Agent/img/BBPS_Logo.png" class="img-fluid" width="50px"></h5>-->
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="px-3">
        <img src="img/BBPS_Logo.png" width="120" style="float:right">
      </div>
      <form id="BillSubmit" method="post">
      <div class="modal-body">
            ...
            <!--<select name="recharge_operator" id="type" required class="form-control fill">-->
      ...
      <div class="modal-footer">
        ...
        <input type="hidden" id="billfetchrefid"> 
...
<script src="js/BIll_BBPS.js"></script>
