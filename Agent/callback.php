...
if(isset($_POST['submit'])){
    ...
    $update = $con->query("UPDATE `user` SET `CALLBACK_URL`='$callback' where ID='$usid'");
    if(($update)){
        echo "<script>alert('callback updated');location.replace('callback')</script>";
    }else{
        echo "<script>alert('Failed to update callback');location.replace('callback')</script>";
      ...
      <div class="container-fluid">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Callback Url</h3>
        ...
        <div class="container">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-12">
                    <div class="wizard">
                        <form class="TicketRise_form" method="POST" action="callback.php">
                            <div class="tab-content">
                                <div class="tab-pane active" role="tabpanel" id="step1">
                                    <h3 class="text-center text-primary">Callback Url</h3>
                                     <hr>
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="callback" id="callback" value="<?php echo $userKey['CALLBACK_URL']?>" placeholder="Enter callback url" autocomplete="off" />
                                            </div>
                                        </div>
