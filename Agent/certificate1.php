            ...
            <div class="col-xs-12">
              <div class="row">
                ...
                <div class="pm-course-title col-xs-8 text-center">
                  <span class="pm-earned-text block cursive">Certification Of <?php echo $type?></span>
                </div>
                <div class="col-xs-2"><!-- LEAVE EMPTY --></div>
              </div>
            </div>
        ...
        <div class="col-xs-12">
          <div class="row">
            <div class="pm-certificate-footer">
                ...
                <div class="col-xs-4 pm-certified col-xs-4 text-center">
                  <span class="pm-credits-text block sans">Joining Date</span><br>
                  <span class="pm-credits-text block sans"><?php echo $date?></span>
                  <span class="block underline"></span>
...
<button onclick="window.print()" style="margin-left: 45%;">Print Certificate</button>
</body>
</html>