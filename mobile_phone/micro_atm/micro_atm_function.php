...
$time = date("Y-m-d g:i:s A");
        ...
        // Insert All Report
        // insert_allreport($user_id  ,$ref_id , "M-ATM Charge" ,$us_main_bal , $crnt_bal , $charge_amount , "Debit" , "M-ATM Transaction Charge");
        ...
        insert_allreport($ds_id  ,$ref_id , "M-ATM Commission" ,$ds_main_bal , $ds_update_bal , $ds_givenCom , $pack['AMOUNT_TYPE'] , "M-ATM Transaction Commission", $ip_address, $device);
        insert_allreport($ms_id  ,$ref_id , "M-ATM Commission" ,$ms_main_bal , $ms_update_bal , $ms_givenCom , $pack['AMOUNT_TYPE'] , "M-ATM Transaction Commission", $ip_address, $device);
...
//             //check amount commission type
//             if($pack['AMOUNT_TYPE'] == "DEBIT"){
//                 $com_amount = ($trans['TRANSAMOUNT']/100)*$com;
//                 $gst = ($com_amount/100)*$pack['GST'];
//                 $tds = ($com_amount/100)*$pack['TDS'];
//                 $givenCom = $com_amount-$gst-$tds;
//                 $update_bal = $crnt_bal-$givenCom;
...
//          $con->query("INSERT INTO `commission_report`(`SERVICE`, `REFFRENCE`, `USER_ID`, `USER_TYPE`, `AMOUNT`, `COMMISSION`,`GST` ,`TDS`, `TIME`) 
//                     VALUES ('AEPS','$ref_id','$user_id','$usertype','".$trans['TRANSAMOUNT']."','$givenCom','$gst' ,'$tds' ,'$time')");
...
//                          $con->query("INSERT INTO `commission_report`(`SERVICE`, `REFFRENCE`, `USER_ID`, `USER_TYPE`, `AMOUNT`, `COMMISSION`,`GST` ,`TDS`, `TIME`) 
//                                     VALUES ('AEPS','$ref_id','$owner','$us_type','".$trans['TRANSAMOUNT']."','$givenCom','$gst' ,'$tds' ,'$time')");
