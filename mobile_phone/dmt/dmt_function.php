<?php
    ...
    function fetch_bene($mobile){
        ...
        curl_setopt_array($curl, [
          CURLOPT_URL => "$base_url/api/v1/service/dmt/beneficiary/registerbeneficiary/fetchbeneficiary",
...
// New Function
function give_dmt_com($ref_id , $user_id , $usertype, $ip_address, $device){
    global $con;
...
$time = date("Y-m-d g:i:s A");
        ...
        $con->query("update dmt_transactions set CHARGE='$charge' where REFFRENCE_ID='$ref_id' and USER_ID='$user_id'");
        ...
        // Insert All Report
        insert_allreport($user_id  ,$ref_id , "DMT Charge" ,$us_main_bal , $crnt_bal , $charge_amount , "Debit" , "DMT Transaction Charge", $ip_address, $device);
        insert_allreport($user_id  ,$ref_id , "DMT Commission" ,$crnt_bal , $update_bal , $givenCom , $pack['AMOUNT_TYPE'] , "DMT Transaction Commission" , $ip_address, $device);
        insert_allreport($ds_id  ,$ref_id , "DMT Commission" ,$ds_main_bal , $ds_update_bal , $ds_givenCom , $pack['AMOUNT_TYPE'] , "DMT Transaction Commission", $ip_address, $device);
        insert_allreport($ms_id  ,$ref_id , "DMT Commission" ,$ms_main_bal , $ms_update_bal , $ms_givenCom , $pack['AMOUNT_TYPE'] , "DMT Transaction Commission", $ip_address, $device);
        
    // return true;
}
// End DMT comission Start
// function give_dmt_com($ref_id , $user_id , $usertype, $ip_address, $device){
//       global $con;
