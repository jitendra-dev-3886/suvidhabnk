...
// }USER_ID='$duserid' AND CATEGORY='$BbpsType' AND MODE='$BbpsMode' AND 

  $sql = "
SELECT * FROM `pay_bill_api` WHERE USER_ID='$duserid' AND `CATEGORY`='$BbpsType' AND MODE='$BbpsMode' AND FILTER_DATE between '$fromdate' and '$todate' ORDER BY ID DESC
";
