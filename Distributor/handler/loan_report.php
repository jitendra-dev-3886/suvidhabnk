...
$duser = $con->query("SELECT * FROM user WHERE OWNER_ID='$id'")->fetch_assoc();

$duserid = $duser["ID"];
 $i = 1;
  
  $sql = "
SELECT * FROM `loan_request` WHERE USER_ID='$duserid' AND date(DATE) between '$fromdate' and '$todate' ORDER BY ID DESC
";
