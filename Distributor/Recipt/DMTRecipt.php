...
$recipt = $con->query("SELECT * FROM dmt_transactions WHERE REFFRENCE_ID = '$refrence'")->fetch_assoc();
...
<div class="receipt">
    <div class="receipt__holder">
        <div class="receipt__headline">
            <h4 class="headline__title receipt__title">DMT Receipt </h4>
        </div>
        ...
        <img src="../dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="rounded mx-auto d-block" width="90">
            ...
            <div class="receipt__actions is-flex-centered is-print-hidden">
                <button  onclick="javascript:location.replace('../MoneyTransferDMTReport')" class="button receipt__button">Back</button>
