  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">SubscriptionList</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">SubscriptionList</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <tbody>
                     ...
                     <?php
                         $i = 1;
                         $res = $conn->query("SELECT * FROM `subscription`");
                         if($res->num_rows > 0){
                  ...
                  <tr>
                    ...
                    <td><?php echo $sublist['PRICE']; ?></td>
                    <td><?php echo $sublist['DESCRIPTION']; ?></td>
                    <td><?php echo $sublist['VALIDITY']; ?></td>
                    <td><?php echo $sublist['USER']; ?></td>
                    <td><?php echo $sublist['STATUS']; ?></td>
	            	<td><a href="edit_CreateSubscription.php?id=<?php echo $sublist["ID"]; ?>"  class="fas fa-edit" ></a> &nbsp; &nbsp; &nbsp;
	            	<a href="edit_CreateSubscription.php?delete&id=<?php echo $sublist["ID"]; ?>" onclick="javascript:confirmationDelete($(this));return false;"><i class="fas fa-trash"></i></a></td>
