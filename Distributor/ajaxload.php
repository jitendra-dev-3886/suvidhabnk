...
$live = $con->query("SELECT * FROM user WHERE OWNER_ID = '$usid' AND MOBILE = '$mobileid' OR PARTNER_ID ='$mobileid'") or die('sql query failed');
...
$output .= "<div id='livefetch' class='form-row d-flex justify-content-around '>
                ...
                <div class='form-row d-flex justify-content-around'>
                    <div class='form-group col-md-5'>
                        ...
                        <span class='text-danger amterror'></span>
                    </div>
                    <div class='form-group col-md-5'>
    ...
    $output .= "<h2 class='text-danger'>Data Not Found</h2>";
}
