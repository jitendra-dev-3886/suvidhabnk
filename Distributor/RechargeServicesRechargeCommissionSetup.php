              ...
              <div class="card-body">
                 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                         include('config.php');
                         $i=1;
                         $res= $conn->query("SELECT * FROM `commission_package` WHERE USER_TYPE='46' AND SERVICES='Recharge' ORDER BY ID DESC");
                         if($res->num_rows >0){
                  ...
                  <tr>
                    ...
                    <td><a href="#" class="fas fa-edit"  name="edit"  data-toggle="modal" data-target="#exampleModaledit" id="<?php echo $row["id"]; ?>"></a>&nbsp;  &nbsp; <a href="#" name="button" onclick = "deletedata(<?php echo $row['ID']; ?>);"><i class="fas fa-trash"></i></i></a></i></td>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                         ...
                         include("../Db/config.php");
                         $i=1;
                         $res= $conn->query("SELECT * FROM `commission_package` WHERE USER_TYPE='company' AND SERVICES='Recharge' ORDER BY ID DESC");
                         if($res->num_rows >0){
                             while($row = $res->fetch_assoc()){
