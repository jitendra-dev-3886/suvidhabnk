                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      <?php
                         ...
                         $res= $conn->query("SELECT * FROM `slab_commission` WHERE COMM_PACK_ID ='$com_pack_id' ORDER BY ID DESC");
                         if($res->num_rows >0){
                  ...
                  <tr>
                    ...
                    <td><a href="#" name="button" onclick = "deletedata(<?php echo $setAeps['ID']; ?>);"><i class="fas fa-trash"></i></i></a></i></td>
